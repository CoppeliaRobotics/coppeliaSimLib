...
bool isSimulatorInitialized(const char* functionName)
{
    ...
    {
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_SIMULATOR_NOT_INITIALIZED);
        return(false);
    }
    return(true);
}
...
bool ifEditModeActiveGenerateErrorAndReturnTrue(const char* functionName)
{
    ...
    {
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERRROR_EDIT_MODE_ACTIVE);
        return(true);
    }
    return(false);
}
...
{ // 'when' coding: bit0: sim not launched(1), bit1: sim launched(2), bit2: mainWindow not present(4),
    ...
    if (((st&3)&when)==0)
    {
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_CANNOT_SET_GET_PARAM_LAUNCH);
        return(false);
    }
    if (((st&12)&when)==0)
    {
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_CANNOT_SET_GET_PARAM_WINDOW);
        return(false);
    }
    if (((st&48)&when)==0)
    {
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_CANNOT_SET_GET_PARAM_SIM);
        return(false);
    }
    return(true);
}
...
bool doesObjectExist(const char* functionName,int identifier)
{
    ...
    if (it==nullptr)
    {
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_OBJECT_INEXISTANT);
        return(false);
    }
    else
        return(true);
...
bool doesEntityExist(const char* functionName,int identifier)
{
    if (identifier>=SIM_IDSTART_COLLECTION)
    {
        ...
        {
            CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_ENTITY_INEXISTANT);
            return(false);
        }
        return(true);
    }
...
bool doesCollectionExist(const char* functionName,int identifier)
{
    if (App::currentWorld->collections->getObjectFromHandle(identifier)==nullptr)
    {
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_COLLECTION_INEXISTANT);
        return(false);
    }
    return(true);
}
...
bool doesCollisionObjectExist(const char* functionName,int identifier)
{
    ...
    {
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_COLLISION_INEXISTANT);
        return(false);
    }
    else
        return(true);
...
bool doesDistanceObjectExist(const char* functionName,int identifier)
{
    ...
    {
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_DISTANCE_INEXISTANT);
        return(false);
    }
    else
        return(true);
...
bool isJoint(const char* functionName,int identifier)
{
    ...
    { 
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_OBJECT_NOT_JOINT);
        return(false);
    }
    return(true);
}
bool isShape(const char* functionName,int identifier)
{
    ...
    { 
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_OBJECT_NOT_SHAPE);
        return(false);
    }
    return(true);
}
bool isSensor(const char* functionName,int identifier)
{
    ...
    { 
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_OBJECT_NOT_PROX_SENSOR);
        return(false);
    }
    return(true);
}
bool isMill(const char* functionName,int identifier)
{
    ...
    { 
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_OBJECT_NOT_MILL);
        return(false);
    }
    return(true);
}
bool isForceSensor(const char* functionName,int identifier)
{
    ...
    { 
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_OBJECT_NOT_FORCE_SENSOR);
        return(false);
    }
    return(true);
}
bool isVisionSensor(const char* functionName,int identifier)
{
    ...
    { 
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_OBJECT_NOT_VISION_SENSOR);
        return(false);
    }
    return(true);
}
bool isCamera(const char* functionName,int identifier)
{
    ...
    {
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_OBJECT_NOT_CAMERA);
        return(false);
    }
    return(true);
}
bool isGraph(const char* functionName,int identifier)
{
    ...
    { 
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_OBJECT_NOT_GRAPH);
        return(false);
    }
    return(true);
}
bool isPath(const char* functionName,int identifier)
{
    ...
    { 
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_OBJECT_NOT_PATH);
        return(false);
    }
    return(true);
}
bool isLight(const char* functionName,int identifier)
{
    ...
    { 
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_OBJECT_NOT_LIGHT);
        return(false);
    }
    return(true);
}
bool isDummy(const char* functionName,int identifier)
{
    ...
    { 
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_OBJECT_NOT_DUMMY);
        return(false);
    }
    return(true);
}
bool isOctree(const char* functionName,int identifier)
{
    ...
    {
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_OBJECT_NOT_OCTREE);
        return(false);
    }
    return(true);
}
bool isPointCloud(const char* functionName,int identifier)
{
    ...
    {
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_OBJECT_NOT_POINTCLOUD);
        return(false);
    }
    return(true);
}
bool doesUIExist(const char* functionName,int elementHandle)
{
    ...
    if (it==nullptr)
    {
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_UI_INEXISTANT);
        return(false);
    }
    return(true);
}
...
bool doesUIButtonExist(const char* functionName,int elementHandle,int buttonHandle)
{
    ...
    {
        CApiErrors::setCapiCallErrorMessage(functionName,SIM_ERROR_UI_BUTTON_INEXISTANT);
        return(false);
    }
    return(true);
}
...
simChar* simGetLastError_internal()
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        std::string lastErr(CApiErrors::getCapiCallErrorMessage());
        if (lastErr.size()==0)
            return(nullptr);
        ...
        CApiErrors::clearCapiCallErrorMessage();
        return(retVal);
    }
    CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_COULD_NOT_LOCK_RESOURCES_FOR_READ);
    return(nullptr);
...
simInt simSetLastError_internal(const simChar* funcName,const simChar* errorMessage)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if (func.compare(0,8,"warning@")==0)
            CApiErrors::setThreadBasedFirstCapiWarning(errorMessage);
        else
            CApiErrors::setThreadBasedFirstCapiError(errorMessage);
        return(1);
    }
    CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_COULD_NOT_LOCK_RESOURCES_FOR_READ);
    return(-1);
...
simInt simRemoveModel_internal(simInt objectHandle)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_WRITE_DATA
    {
        ...
        if (!it->getModelBase())
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_OBJECT_NOT_MODEL_BASE);
            return(-1);
        }
...
simInt simGetJointPosition_internal(simInt objectHandle,simFloat* position)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_JOINT_SPHERICAL);
            return(-1);
        }
...
simInt simSetJointTargetPosition_internal(simInt objectHandle,simFloat targetPosition)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_JOINT_NOT_IN_FORCE_TORQUE_MODE);
            return(-1);
        }
        return(1);
    }
...
simInt simSetSphericalJointMatrix_internal(simInt objectHandle,const simFloat* matrix)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if (it->getJointType()!=sim_joint_spherical_subtype)
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_JOINT_NOT_SPHERICAL);
            return(-1);
        }
        C4X4Matrix m;
        m.copyFromInterface(matrix);
...
simInt simLoadScene_internal(const simChar* filename)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_WRITE_DATA
    {
        ...
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_SCENE_COULD_NOT_BE_READ);
            return(-1);
        }
...
simInt simSaveScene_internal(const simChar* filename)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_WRITE_DATA
    {
        ...
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_SCENE_COULD_NOT_BE_SAVED);
            return(-1);
        }
...
simInt simSaveModel_internal(int baseOfModelHandle,const simChar* filename)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_WRITE_DATA
    {
        ...
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_MODEL_COULD_NOT_BE_SAVED);
            return(-1);
        }
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if ((targetName.length()==0)||(targetName.compare("child")==0)||(targetName.compare("main")==0))
        {
            if (scriptNameAdjusted.length()==0)
                it=App::currentWorld->luaScriptContainer->getMainScript();
            else
            {
                CSceneObject* obj=App::currentWorld->sceneObjects->getObjectFromName(scriptNameAdjusted.c_str());
                if (obj!=nullptr)
                    it=App::currentWorld->luaScriptContainer->getScriptFromObjectAttachedTo_child(obj->getObjectHandle());
            }
        }
        if (targetName.compare("customization")==0)
        {
            CSceneObject* obj=App::currentWorld->sceneObjects->getObjectFromName(scriptNameAdjusted.c_str());
            if (obj!=nullptr)
                it=App::currentWorld->luaScriptContainer->getScriptFromObjectAttachedTo_customization(obj->getObjectHandle());
        }
        if (it==nullptr)
        {
...
simInt simHandleMainScript_internal()
{
    ...
    App::currentWorld->luaScriptContainer->handleCascadedScriptExecution(sim_scripttype_customizationscript,sim_syscb_beforemainscript,nullptr,&outStack,&res);
    bool cs=(res!=1);
...
simInt simGetScript_internal(simInt index)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        if ( (index<0)||(index>=int(App::currentWorld->luaScriptContainer->allScripts.size())) )
        {
            return(-1);
        }
...
simInt simGetCustomizationScriptAssociatedWithObject_internal(simInt objectHandle)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        CLuaScriptObject* it=App::currentWorld->luaScriptContainer->getScriptFromObjectAttachedTo_customization(objectHandle);
        if (it==nullptr)
        {
            return(-1);
        }
                ...
                { // set association
                    ...
                    { // object does exist
                        ...
                        { // script not yet associated
                            ...
                            if (it->getScriptType()==sim_scripttype_childscript)
                                currentSimilarObj=App::currentWorld->luaScriptContainer->getScriptFromObjectAttachedTo_child(associatedObjectHandle);
                            if (it->getScriptType()==sim_scripttype_customizationscript)
                            ...
                            if (currentSimilarObj==nullptr)
                            {
                                ...
                                CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_OBJECT_ALREADY_ASSOCIATED_WITH_SCRIPT_TYPE);
                        }
                    }
                }
            }
            else
                CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_SCRIPT_NOT_CHILD_OR_CUSTOMIZATION_SCRIPT);
        }
        else
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_SCRIPT_INEXISTANT);
        return(retVal);
...
simInt simRemoveScript_internal(simInt scriptHandle)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_WRITE_DATA
    {
        ...
        { // We wanna remove all scripts!
            ...
            App::currentWorld->luaScriptContainer->removeAllScripts();
            App::setFullDialogRefreshFlag();
            return(1);
        }
        CLuaScriptObject* it=App::currentWorld->luaScriptContainer->getScriptFromID_noAddOnsNorSandbox(scriptHandle);
        ...
        if (App::mainWindow!=nullptr)
            App::mainWindow->codeEditorContainer->closeFromScriptHandle(scriptHandle,nullptr,true);
#endif
        App::currentWorld->luaScriptContainer->removeScript_safe(scriptHandle);
        App::setFullDialogRefreshFlag();
        return(1);
    }
    CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_COULD_NOT_LOCK_RESOURCES_FOR_WRITE);
...
simInt simRegisterScriptCallbackFunction_internal(const simChar* funcNameAtPluginName,const simChar* callTips,simVoid(*callBack)(struct SScriptCallBack* cb))
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_MISSING_PLUGIN_NAME);
            return(-1);
        }

        bool retVal=1;
        if (App::worldContainer->luaCustomFuncAndVarContainer->removeCustomFunction(funcNameAtPluginName))
        ...
        if (!App::worldContainer->luaCustomFuncAndVarContainer->insertCustomFunction(newFunction))
        {
            delete newFunction;
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_CUSTOM_LUA_FUNC_COULD_NOT_BE_REGISTERED);
            return(-1);
        }
        return(retVal);
    }
...
simInt simRegisterScriptVariable_internal(const simChar* varNameAtPluginName,const simChar* varValue,simInt stackHandle)
{
    ...
    {
        bool retVal=1;
        if (App::worldContainer->luaCustomFuncAndVarContainer->removeCustomVariable(varNameAtPluginName))
            retVal=0;// that variable already existed. We remove it and replace it!
        if (!App::worldContainer->luaCustomFuncAndVarContainer->insertCustomVariable(varNameAtPluginName,varValue,stackHandle))
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_CUSTOM_LUA_VAR_COULD_NOT_BE_REGISTERED);
            return(-1);
        }
        return(retVal);
    }
...
simChar* simGetConfigurationTree_internal(simInt objectHandle)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if (objectHandle==sim_handle_all)
            objectHandle=-1;
        char* retVal=App::currentWorld->configurationContainer->getConfigurationTree(objectHandle);
        return(retVal);
    }
    CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_COULD_NOT_LOCK_RESOURCES_FOR_READ);
    return(nullptr);
...
simInt simSetConfigurationTree_internal(const simChar* data)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_WRITE_DATA
    {
        App::currentWorld->configurationContainer->setConfigurationTree(data);
        return(1);
    }
    CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_COULD_NOT_LOCK_RESOURCES_FOR_WRITE);
    return(-1);
...
simChar* simGetObjectConfiguration_internal(simInt objectHandle)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        char* retVal=App::currentWorld->configurationContainer->getObjectConfiguration(objectHandle);
        return(retVal);
    }
    CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_COULD_NOT_LOCK_RESOURCES_FOR_READ);
    return(nullptr);
...
simInt simSetObjectConfiguration_internal(const simChar* data)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_WRITE_DATA
    {
        App::currentWorld->configurationContainer->setObjectConfiguration(data);
        return(1);
    }
    CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_COULD_NOT_LOCK_RESOURCES_FOR_WRITE);
    return(-1);
...
simInt simIsRealTimeSimulationStepNeeded_internal()
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if (!App::currentWorld->simulation->getRealTimeSimulation())
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_SIMULATION_NOT_REAL_TIME);
            return(-1);
        }
...
simChar* simGetScriptRawBuffer_internal(simInt scriptHandle,simInt bufferHandle)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if (buffer==nullptr)
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_BUFFER_INEXISTANT);
            return(nullptr);
        }
        return(buffer);
    }
...
simInt simSerialClose_internal(simInt portHandle)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if (App::worldContainer->serialPortContainer->serialPortClose(portHandle))
            ...
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_INVALID_PORT_HANDLE);
#endif
        return(retVal);
    }
    CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_COULD_NOT_LOCK_RESOURCES_FOR_READ);
...
simInt simImportShape_internal(simInt fileformat,const simChar* pathAndFilename,simInt options,simFloat identicalVerticeTolerance,simFloat scalingFactor)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_WRITE_DATA
    {
        ...
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_ASSIMP_PLUGIN_NOT_FOUND);
            return(-1);
        }
...
simInt simExportMesh_internal(simInt fileformat,const simChar* pathAndFilename,simInt options,simFloat scalingFactor,simInt elementCount,const simFloat** vertices,const simInt* verticesSizes,const simInt** indices,const simInt* indicesSizes,simFloat** reserved,const simChar** names)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if (format.size()==0)
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_INVALID_FILE_FORMAT);
            return(-1);
        }
...
simInt simFloatingViewAdd_internal(simFloat posX,simFloat posY,simFloat sizeX,simFloat sizeY,simInt options)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_WRITE_DATA
    {
        ...
        if (page==nullptr)
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_PAGE_INEXISTANT);
            return(-1);
        }
...
simInt simAdjustView_internal(simInt viewHandleOrIndex,simInt associatedViewableObjectHandle,simInt options,const simChar* viewLabel)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if (associatedViewableObjectHandle!=-1)
        {
            ...
            {
                CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_OBJECT_IS_NOT_VIEWABLE);
                return(-1);
            }
        }
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_WRITE_DATA
    {
        ...
        */
        ...
        else
        {
            if (dividing)
            {
                CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_CANNOT_DIVIDE_COMPOUND_SHAPE);
                shapeCount[0]=0;
                return(nullptr);
            }
        }
...
simInt simGetTextureId_internal(const simChar* textureName,simInt* resolution)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if (to!=nullptr)
        {
            ...
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_TEXTURE_INEXISTANT);
        return(retVal);
    }
    CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_COULD_NOT_LOCK_RESOURCES_FOR_READ);
    return(-1);
...
simInt simCallScriptFunctionEx_internal(simInt scriptHandleOrType,const simChar* functionNameAtScriptName,simInt stackId)
{
    ...
    if (script!=nullptr)
    {
        ...
        if (stack!=nullptr)
        {
            ...
            if (retVal==-1)
            {
                CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_ERROR_IN_SCRIPT_FUNCTION);
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_WRITE_DATA
    {
        ...
        if (stack!=nullptr)
        {
            if (stack->moveStackItemToTop(cIndex))
                return(1);
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_INVALID_INDEX);
            return(-1);
        }
        CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_INVALID_HANDLE);
        return(-1);
...
simChar* simGetApiInfo_internal(simInt scriptHandleOrType,const simChar* apiWord)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if ( (scriptType>=0)&&(strlen(apiWord)>0) )
        {
            ...
            if (tip.size()==0)
            {
                for (size_t i=0;i<App::worldContainer->luaCustomFuncAndVarContainer->allCustomFunctions.size();i++)
                {
                    std::string n=App::worldContainer->luaCustomFuncAndVarContainer->allCustomFunctions[i]->getFunctionName();
                    if (n.compare(apiWord)==0)
                    {
                        tip=App::worldContainer->luaCustomFuncAndVarContainer->allCustomFunctions[i]->getCallTips();
                        break;
                    }
                }
            }
...
simInt simSetModuleInfo_internal(const simChar* moduleName,simInt infoType,const simChar* stringInfo,simInt intInfo)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_WRITE_DATA
    {
        ...
        CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_INVALID_PLUGIN_NAME);
        return(-1);
    }
...
simInt simIsDeprecated_internal(const simChar* funcOrConst)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if (retVal<0)
            retVal=App::worldContainer->luaCustomFuncAndVarContainer->isFuncOrConstDeprecated(funcOrConst);
        return(retVal);
    }
    CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_COULD_NOT_LOCK_RESOURCES_FOR_READ);
    return(-1);
        ...
        if (isShape(__func__,shapeHandle))
        {
            ...
            if (shape->getMeshWrapper()->isMesh())
            {
                ...
                if (shape->getSingleMesh()->getIndices()->size()*2==textCoordSize)
                {
                    ...
                    CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_BAD_TEXTURE_COORD_SIZE);
            }
            else
                CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_CANNOT_BE_COMPOUND_SHAPE);
        }
        return(retVal);
    }
    CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_COULD_NOT_LOCK_RESOURCES_FOR_WRITE);
...
{
    TRACE_C_API;
    ((CSceneObject*)object)->disableDynamicTreeForManipulation(disableFlag!=0);
}
...
{ // Careful with this function: it can also be called from any other thread (e.g. generated by the physics engine)
    ...
    if ( ((engine&1024)==0)&&App::currentWorld->luaScriptContainer->isContactCallbackFunctionAvailable() ) // the engine flag 1024 means: the calling thread is not the simulation thread. We would have problems with the scripts
    {
        ...
        CInterfaceStack outStack;
        int retInfo=0;
        App::currentWorld->luaScriptContainer->handleCascadedScriptExecution(sim_scripttype_childscript,sim_syscb_contactcallback,&inStack,&outStack,&retInfo);
        if (retInfo>0)
            App::currentWorld->luaScriptContainer->handleCascadedScriptExecution(sim_scripttype_customizationscript,sim_syscb_contactcallback,&inStack,&outStack,&retInfo);
...
simVoid _simDynCallback_internal(const simInt* intData,const simFloat* floatData)
{
    ...
    CInterfaceStack inStack;
    if (App::currentWorld->luaScriptContainer->isDynCallbackFunctionAvailable())
    { // to make it a bit faster than blindly parsing the whole object hierarchy
        ...
        App::currentWorld->luaScriptContainer->handleCascadedScriptExecution(sim_scripttype_childscript,sim_syscb_dyncallback,&inStack,nullptr,nullptr);
        App::currentWorld->luaScriptContainer->handleCascadedScriptExecution(sim_scripttype_customizationscript,sim_syscb_dyncallback,&inStack,nullptr,nullptr);
    }
}
...
{ // DEPRECATED since 21/1/2016   referenceConfigs can be nullptr, as well as jointWeights
    TRACE_C_API;
    CApiErrors::setCapiCallErrorMessage(__func__,"Not supported anymore.");
    return(-1);
}
...
{ // DEPRECATED since release 3.3.0
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if (it==nullptr)
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_PATH_PLANNING_OBJECT_INEXISTANT);
            return(-1);
        }
...
{ // DEPRECATED since release 3.3.0
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_TOO_MANY_TEMP_OBJECTS);
            return(-1);
        }
        ...
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_PATH_PLANNING_OBJECT_NOT_CONSISTENT);
            delete it;
        }
        return(retVal);
    }
...
{ // DEPRECATED since release 3.3.0
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if (it==nullptr)
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_TEMP_PATH_SEARCH_OBJECT_INEXISTANT);
            return(-1);
        }
        if (abortSearch)
        {
...
{ // deprecated (10/04/2012)
    ...
    if (App::worldContainer->serialPortContainer->serialPortClose_old(portNumber))
        return(1);
    CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_PORT_NOT_OPEN);
#endif
    return(-1);
}
...
simInt simCreateUI_internal(const simChar* elementName,simInt menuAttributes,const simInt* clientSize,const simInt* cellSize,simInt* buttonHandles)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_WRITE_DATA
    {
        ...
        if (b>s[0])
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_INVALID_DIMENSIONS);
            return(-1);
        }
...
simInt simCreateUIButton_internal(simInt elementHandle,const simInt* position,const simInt* size,simInt buttonProperty)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_WRITE_DATA
    {
        ...
        {
            delete but;
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_WRONG_POS_SIZE_PARAMS);
            return(-1);
        }
...
simInt simGetUIHandle_internal(const simChar* elementName)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        if (it==nullptr)
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_UI_INEXISTANT);
            return(-1);
        }
        int retVal=it->getBlockID();
        return(retVal);
...
simInt simSetUISlider_internal(simInt elementHandle,simInt buttonHandle,simInt position)
{
    ...
    IF_C_API_SIM_OR_UI_THREAD_CAN_READ_DATA
    {
        ...
        {
            CApiErrors::setCapiCallErrorMessage(__func__,SIM_ERROR_BUTTON_NOT_SLIDER);
            return(-1);
        }
...
{ // deprecated
    ...
    {
        bool retVal=1;
        if (App::worldContainer->luaCustomFuncAndVarContainer->removeCustomFunction(funcName))
            retVal=0;// that function already existed. We remove it and replace it!
