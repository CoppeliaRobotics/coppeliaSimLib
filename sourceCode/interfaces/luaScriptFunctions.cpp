...
const SLuaCommands simLuaCommands[]=
{
    ...
    {"sim.createJoint",_simCreateJoint,                          "int jointHandle=sim.createJoint(int jointType,int jointMode,int options,table[2] sizes=nil)",true},
    {"sim.createDummy",_simCreateDummy,                          "int dummyHandle=sim.createDummy(float size)",true},
    {"sim.createProximitySensor",_simCreateProximitySensor,      "int sensorHandle=sim.createProximitySensor(int sensorType,int subType,int options,table[8] intParams,\ntable[15] floatParams)",true},
    {"sim.createForceSensor",_simCreateForceSensor,              "int sensorHandle=sim.createForceSensor(int options,table[5] intParams,table[5] floatParams)",true},
    {"sim.createVisionSensor",_simCreateVisionSensor,            "int sensorHandle=sim.createVisionSensor(int options,table[4] intParams,table[11] floatParams)",true},
