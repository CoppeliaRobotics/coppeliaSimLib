...
const SLuaCommands simLuaCommands[]=
{
    ...
    {"sim.multiplyVector",_simMultiplyVector,                    "float[3*n] resultVector=sim.multiplyVector(float[7] pose,float[3*n] vector)\nfloat[3*n] resultVector=sim.multiplyVector(float[12] matrix,float[3*n] vector)",true},
