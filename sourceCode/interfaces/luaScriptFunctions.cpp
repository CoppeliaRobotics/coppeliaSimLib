...
const SLuaCommands simLuaCommands[]=
{
    ...
    {"sim.addDrawingObject",_simAddDrawingObject,                "int drawingObjectHandle=sim.addDrawingObject(int objectType,float size,float duplicateTolerance,int parentObjectHandle,int maxItemCount,float[3] ambient_diffuse=nil,float[3] reserved=nil,float[3] specular=nil,float[3] emission=nil)",true},
    ...
    {"sim.addParticleObject",_simAddParticleObject,              "int particleObjectHandle=sim.addParticleObject(int objectType,float size,float density,float[] params,float lifeTime,int maxItemCount,float[3] ambient_diffuse=nil,float[3] reserved=nil,float[3] specular=nil,float[3] emission=nil)",true},
