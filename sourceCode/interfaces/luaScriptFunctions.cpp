...
const SLuaCommands simLuaCommands[]=
{
    ...
    {"sim.multiplyVector",_simMultiplyVector,                    "float[3*n] resultVector=sim.multiplyVector(float[7]/float[12] pose/matrix,float[3*n] vector)",true},
    ...
    {"sim.loadScene",_simLoadScene,                              "sim.loadScene(string/buffer filename)",true},
    {"sim.closeScene",_simCloseScene,                            "int result=sim.closeScene()",true},
    {"sim.saveScene",_simSaveScene,                              "buffer serializedScene=sim.saveScene(string filename)",true},
    {"sim.loadModel",_simLoadModel,                              "int objectHandle=sim.loadModel(string/buffer filename)",true},
    {"sim.saveModel",_simSaveModel,                              "buffer serializedModel=sim.saveModel(int modelBaseHandle,string filename=nil)",true},
    ...
    {"sim.setThreadAutomaticSwitch",_simSetThreadAutomaticSwitch,"int autoSwitchForbidLevel=sim.setThreadAutomaticSwitch(bool automaticSwitch/int forbidLevel)",true},
    ...
    {"sim.setThreadSwitchAllowed",_simSetThreadSwitchAllowed,    "int forbidLevel=sim.setThreadSwitchAllowed(bool allowed/int forbidLevel)",true},
    ...
    {"sim.loadImage",_simLoadImage,                              "buffer image,int[2] resolution=sim.loadImage(int options,string/buffer filename)",true},
    ...
    {"sim.packTable",_simPackTable,                              "buffer buffer=sim.packTable(any[]/map aTable,int scheme=0)",true},
    {"sim.unpackTable",_simUnpackTable,                          "any[]/map aTable=sim.unpackTable(buffer buffer)",true},
    ...
    {"sim.addDrawingObject",_simAddDrawingObject,                "int drawingObjectHandle=sim.addDrawingObject(int objectType,float size,float duplicateTolerance,int parentObjectHandle,int maxItemCount,float[3] ambient_diffuse=nil,nil,float[3] specular=nil,float[3] emission=nil)",true},
    ...
    {"sim.addParticleObject",_simAddParticleObject,              "int particleObjectHandle=sim.addParticleObject(int objectType,float size,float density,float[] params,float lifeTime,int maxItemCount,float[3] ambient_diffuse=nil,nil,float[3] specular=nil,float[3] emission=nil)",true},
    {"sim.removeParticleObject",_simRemoveParticleObject,        "sim.removeParticleObject(int particleObjectHandle)",true},
    {"sim.addParticleObjectItem",_simAddParticleObjectItem,      "sim.addParticleObjectItem(int particleObjectHandle,float[] itemData)",true},
    ...
    {"sim.setLightParameters",_simSetLightParameters,            "sim.setLightParameters(int lightHandle,int state,nil,float[3] diffusePart,float[3] specularPart)",true},
    ...
    {"sim.cameraFitToView",_simCameraFitToView,                  "int result=sim.cameraFitToView(int viewHandleOrIndex,int[] objectHandles=nil,simInt options=0,simFloat scaling=1)",true},
    ...
    {"sim.handleVisionSensor",_simHandleVisionSensor,            "int detectionCount,float[] auxiliaryValuesPacket1,float[] auxiliaryValuesPacket2,etc.=sim.handleVisionSensor(int sensorHandle)",true},
    ...
    {"sim.getVisionSensorImage",_simGetVisionSensorImage,        "float[]/buffer imageBuffer=sim.getVisionSensorImage(int sensorHandle,int posX=0,int posY=0,int sizeX=0,int sizeY=0,int returnType=0)",true},
    {"sim.setVisionSensorImage",_simSetVisionSensorImage,        "int result=sim.setVisionSensorImage(int sensorHandle,float[]/buffer image)",true},
    ...
    {"sim.getVisionSensorDepthBuffer",_simGetVisionSensorDepthBuffer,"float[]/buffer depthBuffer=sim.getVisionSensorDepthBuffer(int sensorHandle,int posX=0,int posY=0,int sizeX=0,int sizeY=0)",true},
    ...
    {"sim.checkVisionSensorEx",_simCheckVisionSensorEx,          "float[]/buffer buffer=sim.checkVisionSensorEx(int sensorHandle,int entityHandle,bool returnImage)",true},
    ...
    {"sim.registerScriptFuncHook",_simRegisterScriptFuncHook,    "int result=sim.registerScriptFuncHook(string funcToHook,string/function userFunc,bool execBefore)",true},
    ...
    {"sim.getGenesisEvents",_simGetGenesisEvents,                "map[]/buffer events=sim.getGenesisEvents()",true},
