...
class CInterfaceStackTable : public CInterfaceStackObject
{
  public:
    ...
    CInterfaceStackObject* getMapItemAtIndex(size_t ind, std::string& stringKey, double& numberKey, int64_t& integerKey, bool& boolKey, int& keyType) const;
    ...
    void setInt64Array(const int64_t* array, size_t l);
    void setHandleArray(const int64_t* array, size_t l);
    ...
    void appendArrayObject_int64(int64_t value);
    void appendArrayObject_handle(int64_t value);
    ...
    void appendArrayObject_int64Array(const int64_t* arr, size_t l);
    void appendArrayObject_handleArray(const int* arr, size_t l);
    void appendArrayObject_handleArray(const int64_t* arr, size_t l);
    ...
    void appendMapObject_int64(const char* key, int64_t value);
    void appendMapObject_handle(const char* key, int64_t value);
    ...
    void appendMapObject_int64Array(const char* key, const int64_t* arr, size_t l);
    void appendMapObject_handleArray(const char* key, const int64_t* arr, size_t l);
    ...
    void appendMapObject_object(int64_t key, CInterfaceStackObject* obj);
    ...
    bool getInt64Array(int64_t* array, int count) const;
    bool getHandleArray(int64_t* array, int count) const;
    ...
    void getMapKeys(std::vector<std::string>* stringKeys, std::vector<int64_t>* intKeys) const;
    CInterfaceStackObject* getMapObject(const char* fieldName) const;
    CInterfaceStackObject* getIntMapObject(const int64_t key) const;
    ...
    bool fetchInt64FromKey(const char* fieldName, int64_t& v, std::string* errMsg = nullptr) const;
    ...
    bool fetchInt64ArrayFromKey(const char* fieldName, int64_t* arr, size_t cnt, std::string* errMsg = nullptr) const;
