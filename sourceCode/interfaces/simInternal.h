...
int simSetBoolProperty_internal(int64_t target, const char* pName, int pState);
int simGetBoolProperty_internal(int64_t target, const char* pName, int* pState);
int simSetIntProperty_internal(int64_t target, const char* pName, int pState);
int simGetIntProperty_internal(int64_t target, const char* pName, int* pState);
int simSetHandleProperty_internal(int64_t target, const char* pName, int64_t pState);
int simGetHandleProperty_internal(int64_t target, const char* pName, int64_t* pState);
int simSetLongProperty_internal(int64_t target, const char* pName, int64_t pState);
int simGetLongProperty_internal(int64_t target, const char* pName, int64_t* pState);
int simSetFloatProperty_internal(int64_t target, const char* pName, double pState);
...
int simGetBufferProperty_internal(int64_t target, const char* pName, char** buffer, int* bufferL);
int simSetIntArray2Property_internal(int64_t target, const char* pName, const int* pState);
int simGetIntArray2Property_internal(int64_t target, const char* pName, int* pState);
int simSetVector3Property_internal(int64_t target, const char* pName, const double* pState);
int simGetVector3Property_internal(int64_t target, const char* pName, double* pState);
int simSetMatrixProperty_internal(int64_t target, const char* pName, const double* pState, int r, int c);
int simGetMatrixProperty_internal(int64_t target, const char* pName, double** pState, int* r, int* c);
int simSetQuaternionProperty_internal(int64_t target, const char* pName, const double* pState);
...
int simGetIntArrayProperty_internal(int64_t target, const char* pName, int** v, int* vL);
int simSetHandleArrayProperty_internal(int64_t target, const char* pName, const int64_t* v, int vL); // ALL handle items have to be of the same type
int simGetHandleArrayProperty_internal(int64_t target, const char* pName, int64_t** v, int* vL); // ALL handle items have to be of the same type
int simSetStringArrayProperty_internal(int64_t target, const char* pName, const char* v, int cnt);
int simGetStringArrayProperty_internal(int64_t target, const char* pName, char** v, int* cnt);
int simSetMethodProperty_internal(int64_t target, const char* pName, const void* v);
int simGetMethodProperty_internal(int64_t target, const char* pName, void** v);
int simRemoveProperty_internal(int64_t target, const char* pName);
