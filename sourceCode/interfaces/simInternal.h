...
int simSetVectorProperty_internal(long long int target, const char* pName, const double* v, int vL);
double* simGetVectorProperty_internal(long long int target, const char* pName, int* vL);
