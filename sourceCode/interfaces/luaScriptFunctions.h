...
extern int _simPackInt64Table(luaWrap_lua_State* L);
...
extern int _simUnpackInt64Table(luaWrap_lua_State* L);
...
extern int _simCreateMarker(luaWrap_lua_State* L);
...
extern int _simCreateNakedScript(luaWrap_lua_State* L);
extern int _simRemoveNakedScript(luaWrap_lua_State* L);
