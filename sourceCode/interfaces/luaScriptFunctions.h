...
extern int _simAddGraphDataStream(luaWrap_lua_State* L);
extern int _simDestroyGraphCurve(luaWrap_lua_State* L);
extern int _simSetGraphDataStreamTransformation(luaWrap_lua_State* L);
extern int _simDuplicateGraphCurveToStatic(luaWrap_lua_State* L);
extern int _simAddGraphCurve(luaWrap_lua_State* L);
extern int _simSetGraphDataStreamValue(luaWrap_lua_State* L);
...
extern int _simAddCollection(luaWrap_lua_State* L);
