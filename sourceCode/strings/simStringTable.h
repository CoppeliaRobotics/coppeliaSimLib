...
#define IDSNS_MAC_FILE_ATTRIBUTE_PROBLEM "The model folder was not found. If the model folder is present in the CoppeliaSim folder, then it might be that your system has automatically added attributes to all CoppeliaSim files, causing problems. Try running from a terminal\n\n    sudo xattr -r -d com.apple.quarantine *\n\nin the CoppeliaSim folder to strip away those attributes, otherwise you might experiences strange behaviours and crashes."
...
#define IDS_SERIALIZATION_VERSION_TOO_RECENT "The serialization version is too recent and cannot be loaded by this CoppeliaSim version."
