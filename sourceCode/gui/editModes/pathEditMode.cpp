...
void CPathEditMode_old::addMenu(VMenu *menu, CSceneObject *viewableObject)
{
    ...
    menu->appendMenuItem(selSize > 0, false, PATH_EDIT_MODE_OLD_PATH_POINT_COPY_EMCMD,
                         IDS_COPY_SELECTED_PATH_POINTS_MENU_ITEM);
    if (selSize >= 1)
        menu->appendMenuItem((buffSize > 0) && (selSize == 1), false, PATH_EDIT_MODE_OLD_PASTE_PATH_POINT_EMCMD,
                             IDS_PASTE_PATH_POINTS_MENU_ITEM);
    else
        menu->appendMenuItem(buffSize > 0, false, PATH_EDIT_MODE_OLD_PASTE_PATH_POINT_EMCMD,
                             IDS_PASTE_PATH_POINTS_AT_BEGINNING_MENU_ITEM);
    menu->appendMenuItem(selSize > 0, false, PATH_EDIT_MODE_OLD_DELETE_PATH_POINT_EMCMD,
                         IDS_DELETE_SELECTED_PATH_POINTS_MENU_ITEM);
    menu->appendMenuItem(selSize > 0, false, PATH_EDIT_MODE_OLD_PATH_POINT_CUT_EMCMD,
                         IDS_CUT_SELECTED_PATH_POINTS_MENU_ITEM);

    menu->appendMenuSeparator();

    if (selSize >= 1)
        menu->appendMenuItem(selSize == 1, false, PATH_EDIT_MODE_OLD_INSERT_NEW_PATH_POINT_EMCMD,
                             IDS_INSERT_NEW_PATH_POINT_MENU_ITEM);
    else
    ...
    menu->appendMenuItem(_editionPathCont->getBezierPathPointCount() > 1, false,
                         PATH_EDIT_MODE_OLD_MAKE_PATH_FROM_BEZIER_EMCMD, IDS_MAKE_PATH_FROM_BEZIER_PATH_MENU_ITEM);
    menu->appendMenuItem(selSize > 0, false, PATH_EDIT_MODE_OLD_MAKE_DUMMIES_FROM_PATH_CTRL_POINTS_EMCMD,
                         IDS_MAKE_DUMMIES_FROM_PATH_CTRL_POINTS_MENU_ITEM);
    menu->appendMenuItem(selSize > 0, false, PATH_EDIT_MODE_OLD_INVERSE_ORDER_OF_SELECTED_PATH_CTRL_POINTS_EMCMD,
                         IDS_INVERSE_ORDER_OF_SELECTED_PATH_CTRL_POINTS_MENU_ITEM);
    ...
    menu->appendMenuItem(true, false, ANY_EDIT_MODE_FINISH_AND_CANCEL_CHANGES_EMCMD,
                         IDS_LEAVE_EDIT_MODE_AND_CANCEL_CHANGES_MENU_ITEM);
    menu->appendMenuItem(true, false, ANY_EDIT_MODE_FINISH_AND_APPLY_CHANGES_EMCMD,
                         IDS_LEAVE_EDIT_MODE_AND_APPLY_CHANGES_MENU_ITEM);
}
