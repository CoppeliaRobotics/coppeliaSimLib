...
void CQDlgDataStreamSelection::refresh()
{
    ...
    if (first)
    {
        ...
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_X_ABS);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_Y_ABS);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_Z_ABS);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_X_REL);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_Y_REL);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_Z_REL);

        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_VEL_ABS);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_XVEL_ABS);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_YVEL_ABS);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_ZVEL_ABS);

        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_ALPHA_ABS);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_BETA_ABS);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_GAMMA_ABS);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_ALPHA_REL);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_BETA_REL);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_GAMMA_REL);

        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_ALL_ANGULAR_VEL_ABS);

        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_PROXSENSOR_X_ABS);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_PROXSENSOR_Y_ABS);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_PROXSENSOR_Z_ABS);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_PROXSENSOR_X_REL);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_PROXSENSOR_Y_REL);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_PROXSENSOR_Z_REL);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_PROXSENSOR_X_REL_TO_SENSOR);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_PROXSENSOR_Y_REL_TO_SENSOR);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_PROXSENSOR_Z_REL_TO_SENSOR);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_PROXSENSOR_DIST);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_PROXSENSOR_AZIMUTH);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_PROXSENSOR_ELEVATION);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_PROXSENSOR_DETECTION_STATE);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_PROXSENSOR_CALCULATION_TIME);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_NOOBJECT_PROXSENSOR_OVERALL_CALCULATION_TIME);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_MIN_RED);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_MIN_GREEN);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_MIN_BLUE);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_MIN_INTENSITY);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_MIN_DEPTH);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_MAX_RED);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_MAX_GREEN);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_MAX_BLUE);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_MAX_INTENSITY);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_MAX_DEPTH);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_AVG_RED);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_AVG_GREEN);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_AVG_BLUE);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_AVG_INTENSITY);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_AVG_DEPTH);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_DETECTION_STATE);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_VISIONSENSOR_CALCULATION_TIME);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_NOOBJECT_VISIONSENSOR_OVERALL_CALCULATION_TIME);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_FORCESENSOR_FORCE_LENGTH);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_FORCESENSOR_FORCE_X);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_FORCESENSOR_FORCE_Y);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_FORCESENSOR_FORCE_Z);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_FORCESENSOR_TORQUE_LENGTH);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_FORCESENSOR_TORQUE_X);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_FORCESENSOR_TORQUE_Y);
        addElementToCombobox(ui->qqTypeCombo, GRAPH_SCENEOBJECT_FORCESENSOR_TORQUE_Z);
...
void CQDlgDataStreamSelection::on_qqItemCombo_currentIndexChanged(int index)
{
    if (!inRefreshRoutine)
    {
        ui->qqOkCancel->button(QDialogButtonBox::Ok)
            ->setEnabled(ui->qqItemCombo->itemData(ui->qqItemCombo->currentIndex()).toInt() != -1);
    }
}
