    ...
    IF_UI_EVENT_CAN_READ_DATA
    {
        ...
        if (pathCont != nullptr)
        {
            ...
            App::appendSimulationThreadCommand(SET_ATTRIBUTES_PATH_OLD_GUITRIGGEREDCMD,
                                               App::currentWorld->sceneObjects->getLastSelectionHandle(), attr);
...
void CQDlgPaths::on_qqAdjustColor_clicked()
{
    IF_UI_EVENT_CAN_READ_DATA
    {
        CQDlgMaterial::displayMaterialDlg(COLOR_ID_PATH, App::currentWorld->sceneObjects->getLastSelectionHandle(), -1,
                                          GuiApp::mainWindow);
    }
}
    ...
    if (!inMainRefreshRoutine)
    {
        IF_UI_EVENT_CAN_READ_DATA
        {
            App::appendSimulationThreadCommand(
                SET_DISTANCEUNIT_PATH_OLD_GUITRIGGEREDCMD, App::currentWorld->sceneObjects->getLastSelectionHandle(),
