...
#ifdef WIN_SIM
                    position[0]=GuiApp::mainWindow->geometry().width()+GuiApp::mainWindow->geometry().x()-toolDialog->geometry().width()-10; // -10 because when in full-screen, the main window doesn't have a frame and things are a little bit different!!
