...
QWidget* CEditBoxDelegate::createEditor(QWidget* parent, const QStyleOptionViewItem& /* option */,
...
void CEditBoxDelegate::updateEditorGeometry(QWidget* editor, const QStyleOptionViewItem& option,
                                            const QModelIndex& /* index */) const
{
