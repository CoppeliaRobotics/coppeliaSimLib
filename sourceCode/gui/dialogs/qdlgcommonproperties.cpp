...
void CQDlgCommonProperties::refresh()
{
    ...
    CSceneObject* ls = App::scene->sceneObjects->getLastSelectionObject();
    ...
    bool isGraph = false;
    bool isScript = false;
    bool bigSel = App::scene->sceneObjects->getSelectionCount() >= 2;
    if (objIsSelected)
    {
    ...
    if (ls != nullptr)
    {
        ...
        {
            CCollection* it2 = App::scene->collections->getObjectFromIndex(i);
        ...
        {
            CCamera* it2 = App::scene->sceneObjects->getCameraFromIndex(i);
        ...
        {
            CVisionSensor* it2 = App::scene->sceneObjects->getVisionSensorFromIndex(i);
...
void CQDlgCommonProperties::on_qqApplyGeneralProperties_clicked()
{
    IF_UI_EVENT_CAN_READ_DATA
    {
        ...
        {
            CSceneObject* last = App::scene->sceneObjects->getLastSelectionObject();
...
void CQDlgCommonProperties::on_qqAssembling_clicked()
{
    IF_UI_EVENT_CAN_WRITE_DATA
    {
        ...
        theDialog.obj = App::scene->sceneObjects->getLastSelectionObject();
        theDialog.refresh();
...
void CQDlgCommonProperties::on_qqExtensionString_editingFinished()
{
    ...
    IF_UI_EVENT_CAN_WRITE_DATA
    {
        App::appendSimulationThreadCommand(SET_EXTENSIONSTRING_COMMONPROPGUITRIGGEREDCMD,
                                           App::scene->sceneObjects->getLastSelectionHandle(), -1, 0, 0,
