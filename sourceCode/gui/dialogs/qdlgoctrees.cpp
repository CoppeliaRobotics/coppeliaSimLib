...
void CQDlgOctrees::refresh()
{
    ...
    bool sel = App::scene->sceneObjects->isLastSelectionOfType(sim_sceneobject_octree);
...
void CQDlgOctrees::on_qqColor_clicked()
{
    ...
    {
        CQDlgColor::displayDlg(COLOR_ID_OCTREE, App::scene->sceneObjects->getLastSelectionHandle(), -1, 0,
                               GuiApp::mainWindow);
    }
}
