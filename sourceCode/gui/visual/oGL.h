...
class ogl
{
  public:
    ...
    static void setMaterialColor(float amb_r, float amb_g, float amb_b, float spec_r, float spec_g, float spec_b,
    ...
    static void setBlendedMaterialColor(int colorMode, float r, float g, float b, float weight, float r2 = 0.5,
                                        float g2 = 0.5, float b2 = 0.5);
    ...
    static inline void drawSingle3dLine(double p1x, double p1y, double p1z, double p2x, double p2y, double p2z,
                                        const double normalVectorForDiffuseComp[3])
    {
        glBegin(GL_LINES);
        if (normalVectorForDiffuseComp != nullptr)
    ...
    static void drawReference(double size, int color = 0);
