...
void CEngineProperties::_writeJoint(int engine, int jointHandle, CAnnJson &annJson) const
{
    ...
    if (engine == sim_physics_mujoco)
    {
        ...
        annJson.addJson(jmujocoFriction, "frictionLoss",
    ...
    if (engine == sim_physics_vortex)
    {
        ...
        annJson.addJson(jvortexAxisFriction, "coeff",
        ...
        */
        ...
        annJson.addJson(jvortexXaxisPositionFric, "coeff",
        ...
        annJson.addJson(jvortexYaxisPositionFric, "coeff",
        ...
        annJson.addJson(jvortexZaxisPositionFric, "coeff",
        ...
        annJson.addJson(jvortexXaxisOrientationFric, "coeff",
        ...
        annJson.addJson(jvortexYaxisOrientationFric, "coeff",
        ...
        annJson.addJson(jvortexZaxisOrientationFric, "coeff",
        ...
        if (annJson.getValue(annJson.getMainObject()[0], "newton", QJsonValue::Object, val, allErrors))
        {
            ...
            (obj!=nullptr)&&(obj->getObjectType()==sim_sceneobject_joint)&&(obj->getObjectHandle()!=joint->getObjectHandle())
                        ...
                        else
                        {
                            if (allErrors->size()>0)
                                allErrors[0]+="\n";
                            allErrors[0]+="Key 'dependency/joint' does not point to a valid joint object and will be
            ignored.";
                        }
                    }
                    else
...
void CEngineProperties::_writeShape(int engine, int shapeHandle, CAnnJson &annJson) const
{
    ...
    if (engine == sim_physics_bullet)
    {
        ...
        annJson.addJson(jbulletCollMargin, "margin",
        ...
        annJson.addJson(jbulletCollMarginConvex, "margin",
...
void CEngineProperties::_writeGlobal(int engine, CAnnJson &annJson) const
{
    ...
    {
        QJsonObject jbullet;
        iv = _getGlobalIntParam(sim_bullet_global_constraintsolvertype, comment,
    ...
    if (engine == sim_physics_mujoco)
    {
        ...
        iv = _getGlobalIntParam(sim_mujoco_global_rebuildtrigger, comment,
        ...
        iv = _getGlobalIntParam(sim_mujoco_global_overridekin, comment,
...
void CEngineProperties::_getGlobalFloatParams(int item, double *w, size_t cnt, std::string &comment,
                                              const char *additionalComment /*=nullptr*/) const
{
