...
#define DEFINE_PROPERTIES                                                                                                                                                                                                       \
    ...
    FUNCX(propObject_parent, "parent", sim_propertytype_handle, sim_propertyinfo_modelhashexclude, R"===({"label": "Parent", "description": "Parent scene object handle"})===", "")                                              \
    ...
    FUNCX(propObject_handle, "handle", sim_propertytype_handle, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, R"===({"label": "Handle", "description": ""})===", "") \
    ...
    FUNCX(propObject_children, "children", sim_propertytype_handlearray, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, R"===({"label": "Children handles", "description": ""})===", "")                                                    \
