...
#define DEFINE_PROPERTIES                                                                                                                                                                                                       \
    ...
    FUNCX(propObject_parentHandle, "parentHandle", sim_propertytype_int, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, "Parent", "Parent scene object handle")                                              \
    ...
    FUNCX(propObject_movementOptions, "movement.optionsFlags", sim_propertytype_int, 0, "Movement flags", "Scene object movement flags")                                                                                         \
    FUNCX(propObject_movementStepSize, "movement.stepSize", sim_propertytype_floatarray, 0, "Movement step sizes", "Linear and angular step sizes")                                                                              \
    FUNCX(propObject_movementRelativity, "movement.relativity", sim_propertytype_intarray, 0, "Movement relativity", "Movement relativity, linear and angular")                                                                  \
    FUNCX(propObject_movementPreferredAxes, "movement.preferredAxesFlags", sim_propertytype_int, 0, "Preferred axes", "Preferred axes flags (redundant)")                                                                        \
