...
#define DEFINE_PROPERTIES                                                                                                                                                                                                       \
    ...
    FUNCX(propObject_absPose, "absPose", sim_propertytype_pose, sim_propertyinfo_modelhashexclude, "Pose", "Scene object absolute pose")                                                                                                                                 \
    FUNCX(propObject_absPosition, "absPosition", sim_propertytype_vector3, sim_propertyinfo_modelhashexclude, "Position", "Scene object absolute position")                                                                                                                                 \
    FUNCX(propObject_absQuaternion, "absQuaternion", sim_propertytype_quaternion, sim_propertyinfo_modelhashexclude, "Quaternion", "Scene object absolute quaternion")                                                                                                                                 \
    FUNCX(propObject_absEulerAngles, "absEulerAngles", sim_propertytype_vector3, sim_propertyinfo_modelhashexclude, "Euler angles", "Scene object absolute Euler angles")                                                                                                                                 \
