...
#define DEFINE_PROPERTIES                                                                                                                                                                                                       \
    ...
    FUNCX(propObject_objectUid, "objectUid", sim_propertytype_long, sim_propertyinfo_silent | sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, "Object UID", "Scene object unique identifier")                                           \
    ...
    FUNCX(propObject_modelBBSize, "model.bbSize", sim_propertytype_vector3, sim_propertyinfo_silent | sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, "Model bounding boxe size", "")                               \
    FUNCX(propObject_modelBBPos, "model.bbPos", sim_propertytype_vector3, sim_propertyinfo_silent | sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, "Model bounding boxe position", "")                               \
    FUNCX(propObject_pose, "pose", sim_propertytype_pose, 0, "Pose", "Scene object local pose")                                                                                                                                 \
    FUNCX(propObject_position, "position", sim_propertytype_vector3, sim_propertyinfo_silent | sim_propertyinfo_modelhashexclude, "Position", "Scene object local position")                                                                                                                                 \
    ...
    FUNCX(propObject_eulerAngles, "eulerAngles", sim_propertytype_vector3, sim_propertyinfo_silent | sim_propertyinfo_modelhashexclude, "Euler angles", "Scene object local Euler angles")                                                                                                                                 \
    ...
    FUNCX(propObject_handle, "handle", sim_propertytype_handle, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, "Handle", "") \
    FUNCX(propObject_visible, "visible", sim_propertytype_bool, sim_propertyinfo_silent | sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, "Visible", "Whether the scene object is currently visible")                                    \
    ...
    FUNCX(propObject_modelHash, "modelHash", sim_propertytype_string, sim_propertyinfo_silent | sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, "Model hash", "")
