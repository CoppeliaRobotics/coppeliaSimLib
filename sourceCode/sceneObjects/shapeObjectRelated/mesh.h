...
class CMesh : public CMeshWrapper
{
  public:
    ...
    int getBoolProperty(const char* pName, bool& pState, const C7Vector& shapeRelTr);
    int setIntProperty(const char* pName, int pState, const C7Vector& shapeRelTr);
    int getIntProperty(const char* pName, int& pState, const C7Vector& shapeRelTr);
    int setFloatProperty(const char* pName, double pState, const C7Vector& shapeRelTr);
    int getFloatProperty(const char* pName, double& pState, const C7Vector& shapeRelTr);
    int setStringProperty(const char* pName, const char* pState, const C7Vector& shapeRelTr);
    int getStringProperty(const char* pName, std::string& pState, const C7Vector& shapeRelTr);
    int setBufferProperty(const char* pName, const char* buffer, int bufferL, const C7Vector& shapeRelTr);
    int getBufferProperty(const char* pName, std::string& pState, const C7Vector& shapeRelTr);
    int setVector3Property(const char* pName, const C3Vector& pState, const C7Vector& shapeRelTr);
    int getVector3Property(const char* pName, C3Vector& pState, const C7Vector& shapeRelTr);
    int setQuaternionProperty(const char* pName, const C4Vector& pState, const C7Vector& shapeRelTr);
    int getQuaternionProperty(const char* pName, C4Vector& pState, const C7Vector& shapeRelTr);
    int setPoseProperty(const char* pName, const C7Vector& pState, const C7Vector& shapeRelTr);
    int getPoseProperty(const char* pName, C7Vector& pState, const C7Vector& shapeRelTr);
    int setMatrix3x3Property(const char* pName, const C3X3Matrix& pState, const C7Vector& shapeRelTr);
    int getMatrix3x3Property(const char* pName, C3X3Matrix& pState, const C7Vector& shapeRelTr);
    int setMatrix4x4Property(const char* pName, const C4X4Matrix& pState, const C7Vector& shapeRelTr);
    int getMatrix4x4Property(const char* pName, C4X4Matrix& pState, const C7Vector& shapeRelTr);
    int setColorProperty(const char* pName, const float* pState, const C7Vector& shapeRelTr);
    int getColorProperty(const char* pName, float* pState, const C7Vector& shapeRelTr);
    int setVectorProperty(const char* pName, const double* v, int vL, const C7Vector& shapeRelTr);
    int getVectorProperty(const char* pName, std::vector<double>& pState, const C7Vector& shapeRelTr);
