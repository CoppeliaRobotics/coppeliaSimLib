...
#define DEFINE_PROPERTIES                                                                                                                                                              \
    ...
    FUNCX(propMesh_handle, "handle", sim_propertytype_handle, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, R"===({"label": "Handle", "description": "", "handleType": "mesh"})===", "") \
