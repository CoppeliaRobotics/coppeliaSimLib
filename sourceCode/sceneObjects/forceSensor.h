...
#define DEFINE_PROPERTIES                                                                                                                                             \
    ...
    FUNCX(propFSensor_sensorForce, "sensorForce", sim_propertytype_vector3, sim_propertyinfo_notwritable, "Force", "Measured force vector")                           \
    FUNCX(propFSensor_sensorTorque, "sensorTorque", sim_propertytype_vector3, sim_propertyinfo_notwritable, "Torque", "Measured torque vector")                       \
    FUNCX(propFSensor_sensorAverageForce, "filterSensorForce", sim_propertytype_vector3, sim_propertyinfo_notwritable, "Filtered force", "Filtered force vector")     \
    FUNCX(propFSensor_sensorAverageTorque, "filterSensorTorque", sim_propertytype_vector3, sim_propertyinfo_notwritable, "Filtered torque", "Filtered torque vector") \
    FUNCX(propFSensor_intrinsicError, "intrinsicError", sim_propertytype_pose, sim_propertyinfo_notwritable, "Intrinsic error", "Intrinsic error, generated by some physics engines")
