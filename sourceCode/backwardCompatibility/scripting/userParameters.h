...
struct SUserParamEntry
{
    ...
    int properties;    // bit0 set: value not visible during simulation, bit1 set: value is not reset at simulation end,
                       // bit2 set: contains embedded 0's (since 2011/01/23)
};
