...
class CCommTubeContainer
{
  public:
    ...
    int openTube(int header, const char *identifier, bool killAtSimulationEnd,
                 int readBufferSize); // return value is the tube handle for this partner
    ...
    int getTubeStatus(int tubeHandle, int &readBufferFill,
                      int &writeBufferFill); // -1: not existant, 0: not connected, 1: connected
