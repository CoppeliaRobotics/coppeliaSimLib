...
class CLinMotionRoutines
{
  public:
    ...
    static double getDistanceToDeceleration(double currentVelocity, double absAccel, double targetVelocity,
                                            double distanceToLimit);

    static bool getNextValues(double& position, double& velocity, double targetVelocity, double accelAbs,
                              double lowerLimitPosition, double upperLimitPosition, double lowerMaxAbsVel,
                              double upperMaxAbsVel, double& deltaTime);
    static double getMaxVelocityAtPosition(double position, double accelAbs, double lowerLimitPosition,
                                           double upperLimitPosition, double lowerMaxAbsVel, double upperMaxAbsVel);
    ...
    static bool getNextValuesForPath(double& position, double& nominalVelocity, double targetNominalVelocity,
    ...
    static bool getNextValuesForPath(double& position, double nominalVelocity, double lowerLimitPosition,
                                     double upperLimitPosition, double lowerMaxRelVel, double upperMaxRelVel,
                                     double& deltaTime);
    static void adjustNominalVelocity(double& nominalVelocity, double targetNominalVelocity, double acceleration,
                                      double deltaTime);

    static double getCurrentVelocityOnPath(double position, double nominalVelocity, double lowerLimitPosition,
                                           double upperLimitPosition, double lowerMaxRelVel, double upperMaxRelVel);
};
