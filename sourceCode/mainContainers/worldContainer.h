...
#define DEFINE_PROPERTIES \
    FUNCX(propApp_sessionId,                   "sessionId",                        sim_propertytype_string,    sim_propertyinfo_notwritable) \
    FUNCX(propApp_protocolVersion,             "protocolVersion",                  sim_propertytype_int,       sim_propertyinfo_notwritable) \
    FUNCX(propApp_productVersion,              "productVersion",                   sim_propertytype_string,    sim_propertyinfo_notwritable) \
    FUNCX(propApp_productVersionNb,            "productVersionNb",                 sim_propertytype_int,    sim_propertyinfo_notwritable) \
    FUNCX(propApp_platform,                    "platform",                         sim_propertytype_int,    sim_propertyinfo_notwritable) \
    FUNCX(propApp_flavor,                      "flavor",                           sim_propertytype_int,    sim_propertyinfo_notwritable) \
    FUNCX(propApp_qtVersion,                   "qtVersion",                        sim_propertytype_int,    sim_propertyinfo_notwritable) \
    FUNCX(propApp_processId,                   "processId",                        sim_propertytype_int,    sim_propertyinfo_notwritable) \
    FUNCX(propApp_processCnt,                  "processCnt",                       sim_propertytype_int,    sim_propertyinfo_notwritable) \
