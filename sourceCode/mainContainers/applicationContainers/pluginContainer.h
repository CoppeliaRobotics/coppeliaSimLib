...
class CPluginContainer
{
  public:
    ...
    double dyn_computeInertia(int shapeHandle, CPose& tr, C3Vector& diagI);
    double dyn_computePMI(const std::vector<double>& vertices, const std::vector<int>& indices, CPose& tr, C3Vector& diagI);
    ...
    void* geomPlugin_createMesh(const double* vertices, int verticesSize, const int* indices, int indicesSize, const CPose* meshOrigin = nullptr, double triangleEdgeMaxLength = 0.3, int maxTrianglesInBoundingBox = 8);
    ...
    void* geomPlugin_createOctreeFromPoints_rgb(const double* points, int pointCnt, const CPose* octreeOrigin = nullptr, double cellS = 0.05, const unsigned char rgbData[3] = nullptr, unsigned int usrData = 0);
    void* geomPlugin_createOctreeFromColorPoints_rgb(const double* points, int pointCnt, const CPose* octreeOrigin = nullptr, double cellS = 0.05, const unsigned char* rgbData = nullptr, const unsigned int* usrData = nullptr);
    void* geomPlugin_createOctreeFromMesh_rgb(const void* meshObbStruct, const CPose& meshTransformation, const CPose* octreeOrigin = nullptr, double cellS = 0.05, const unsigned char rgbData[3] = nullptr, unsigned int usrData = 0);
    void* geomPlugin_createOctreeFromOctree_rgb(const void* otherOctreeStruct, const CPose& otherOctreeTransformation, const CPose* newOctreeOrigin = nullptr, double newOctreeCellS = 0.05, const unsigned char rgbData[3] = nullptr, unsigned int usrData = 0);
    void* geomPlugin_createOctreeFromPoints_rgba(const double* points, int pointCnt, const CPose* octreeOrigin = nullptr, double cellS = 0.05, const unsigned char rgbaData[4] = nullptr, unsigned int usrData = 0);
    void* geomPlugin_createOctreeFromColorPoints_rgba(const double* points, int pointCnt, const CPose* octreeOrigin = nullptr, double cellS = 0.05, const unsigned char* rgbaData = nullptr, const unsigned int* usrData = nullptr);
    void* geomPlugin_createOctreeFromMesh_rgba(const void* meshObbStruct, const CPose& meshTransformation, const CPose* octreeOrigin = nullptr, double cellS = 0.05, const unsigned char rgbaData[4] = nullptr, unsigned int usrData = 0);
    void* geomPlugin_createOctreeFromOctree_rgba(const void* otherOctreeStruct, const CPose& otherOctreeTransformation, const CPose* newOctreeOrigin = nullptr, double newOctreeCellS = 0.05, const unsigned char rgbaData[4] = nullptr, unsigned int usrData = 0);
    ...
    void geomPlugin_insertPointsIntoOctree_rgb(void* ocStruct, const CPose& octreeTransformation, const double* points, int pointCnt, const unsigned char rgbData[3] = nullptr, unsigned int usrData = 0);
    void geomPlugin_insertColorPointsIntoOctree_rgb(void* ocStruct, const CPose& octreeTransformation, const double* points, int pointCnt, const unsigned char* rgbData = nullptr, const unsigned int* usrData = nullptr);
    void geomPlugin_insertMeshIntoOctree_rgb(void* ocStruct, const CPose& octreeTransformation, const void* obbStruct, const CPose& meshTransformation, const unsigned char rgbData[3] = nullptr, unsigned int usrData = 0);
    void geomPlugin_insertOctreeIntoOctree_rgb(void* oc1Struct, const CPose& octree1Transformation, const void* oc2Struct, const CPose& octree2Transformation, const unsigned char rgbData[3] = nullptr, unsigned int usrData = 0);
    void geomPlugin_insertPointsIntoOctree_rgba(void* ocStruct, const CPose& octreeTransformation, const double* points, int pointCnt, const unsigned char rgbaData[4] = nullptr, unsigned int usrData = 0);
    void geomPlugin_insertColorPointsIntoOctree_rgba(void* ocStruct, const CPose& octreeTransformation, const double* points, int pointCnt, const unsigned char* rgbaData = nullptr, const unsigned int* usrData = nullptr);
    void geomPlugin_insertMeshIntoOctree_rgba(void* ocStruct, const CPose& octreeTransformation, const void* obbStruct, const CPose& meshTransformation, const unsigned char rgbaData[4] = nullptr, unsigned int usrData = 0);
    void geomPlugin_insertOctreeIntoOctree_rgba(void* oc1Struct, const CPose& octree1Transformation, const void* oc2Struct, const CPose& octree2Transformation, const unsigned char rgbaData[4] = nullptr, unsigned int usrData = 0);
    bool geomPlugin_removePointsFromOctree(void* ocStruct, const CPose& octreeTransformation, const double* points, int pointCnt);
    bool geomPlugin_removeMeshFromOctree(void* ocStruct, const CPose& octreeTransformation, const void* obbStruct, const CPose& meshTransformation);
    bool geomPlugin_removeOctreeFromOctree(void* oc1Struct, const CPose& octree1Transformation, const void* oc2Struct, const CPose& octree2Transformation);

           // Point cloud creation/destruction/manipulation/info
    void* geomPlugin_createPtcloudFromPoints_rgb(const double* points, int pointCnt, const CPose* ptcloudOrigin = nullptr, double cellS = 0.05, int maxPointCnt = 20, const unsigned char rgbData[3] = nullptr, double proximityTol = 0.005);
    void* geomPlugin_createPtcloudFromColorPoints_rgb(const double* points, int pointCnt, const CPose* ptcloudOrigin = nullptr, double cellS = 0.05, int maxPointCnt = 20, const unsigned char* rgbData = nullptr, double proximityTol = 0.005);
    void* geomPlugin_createPtcloudFromPoints_rgba(const double* points, int pointCnt, const CPose* ptcloudOrigin = nullptr, double cellS = 0.05, int maxPointCnt = 20, const unsigned char rgbaData[4] = nullptr, double proximityTol = 0.005);
    void* geomPlugin_createPtcloudFromColorPoints_rgba(const double* points, int pointCnt, const CPose* ptcloudOrigin = nullptr, double cellS = 0.05, int maxPointCnt = 20, const unsigned char* rgbaData = nullptr, double proximityTol = 0.005);
    ...
    void geomPlugin_insertPointsIntoPtcloud_rgb(void* pcStruct, const CPose& ptcloudTransformation, const double* points, int pointCnt, const unsigned char rgbData[3] = nullptr, double proximityTol = 0.001);
    void geomPlugin_insertColorPointsIntoPtcloud_rgb(void* pcStruct, const CPose& ptcloudTransformation, const double* points, int pointCnt, const unsigned char* rgbData = nullptr, double proximityTol = 0.001);
    void geomPlugin_insertPointsIntoPtcloud_rgba(void* pcStruct, const CPose& ptcloudTransformation, const double* points, int pointCnt, const unsigned char rgbaData[4] = nullptr, double proximityTol = 0.001);
    void geomPlugin_insertColorPointsIntoPtcloud_rgba(void* pcStruct, const CPose& ptcloudTransformation, const double* points, int pointCnt, const unsigned char* rgbaData = nullptr, double proximityTol = 0.001);
    bool geomPlugin_removePointsFromPtcloud(void* pcStruct, const CPose& ptcloudTransformation, const double* points, int pointCnt, double proximityTol, int* countRemoved = nullptr);
    bool geomPlugin_removeOctreeFromPtcloud(void* pcStruct, const CPose& ptcloudTransformation, const void* ocStruct, const CPose& octreeTransformation, int* countRemoved = nullptr);
    bool geomPlugin_intersectPointsWithPtcloud(void* pcStruct, const CPose& ptcloudTransformation, const double* points, int pointCnt, double proximityTol = 0.001);
    ...
    bool geomPlugin_getBoxSegmentCollision(const CPose& boxTransformation, const C3Vector& boxHalfSize, bool boxIsSolid, const C3Vector& segmentEndPoint, const C3Vector& segmentVector);
    bool geomPlugin_getBoxPointCollision(const CPose& boxTransformation, const C3Vector& boxHalfSize, const C3Vector& point);
    ...
    bool geomPlugin_getBoxTriangleDistanceIfSmaller(const CPose& boxTransformation, const C3Vector& boxHalfSize, bool boxIsSolid, const C3Vector& p, const C3Vector& v, const C3Vector& w, double& dist, C3Vector* distSegPt1 = nullptr, C3Vector* distSegPt2 = nullptr, bool altRoutine = false);
    bool geomPlugin_getBoxSegmentDistanceIfSmaller(const CPose& boxTransformation, const C3Vector& boxHalfSize, bool boxIsSolid, const C3Vector& segmentEndPoint, const C3Vector& segmentVector, double& dist, C3Vector* distSegPt1 = nullptr, C3Vector* distSegPt2 = nullptr, bool altRoutine = false);
    bool geomPlugin_getBoxPointDistanceIfSmaller(const CPose& boxTransformation, const C3Vector& boxHalfSize, bool boxIsSolid, const C3Vector& point, double& dist, C3Vector* distSegPt1 = nullptr);
    double geomPlugin_getBoxPointDistance(const CPose& boxTransformation, const C3Vector& boxHalfSize, bool boxIsSolid, const C3Vector& point, C3Vector* distSegPt1 = nullptr);
    ...
    bool geomPlugin_getSegmentPointDistanceIfSmaller(const C3Vector& segmentEndPoint, const C3Vector& segmentVector, const C3Vector& point, double& dist, C3Vector* minDistSegPt = nullptr);
           ...
           // Volume sensor
    bool geomPlugin_volumeSensorDetectMeshIfSmaller(const std::vector<double>& planesIn, const std::vector<double>& planesOut, const void* obbStruct, const CPose& meshTransformation, double& dist, bool fast = false, bool frontDetection = true, bool backDetection = true, double maxAngle = 0.0, C3Vector* detectPt = nullptr, C3Vector* triN = nullptr);
    bool geomPlugin_volumeSensorDetectOctreeIfSmaller(const std::vector<double>& planesIn, const std::vector<double>& planesOut, const void* ocStruct, const CPose& octreeTransformation, double& dist, bool fast = false, bool frontDetection = true, bool backDetection = true, double maxAngle = 0.0, C3Vector* detectPt = nullptr, C3Vector* triN = nullptr);
    bool geomPlugin_volumeSensorDetectPtcloudIfSmaller(const std::vector<double>& planesIn, const std::vector<double>& planesOut, const void* pcStruct, const CPose& ptcloudTransformation, double& dist, bool fast = false, C3Vector* detectPt = nullptr);
    ...
    CQuaternion oldIkPlugin_getSphericalJointQuaternion(int jointHandle);
    void oldIkPlugin_setSphericalJointQuaternion(int jointHandle, const CQuaternion& quaternion);
    ...
    void oldIkPlugin_setIkElementPrecision(int ikGroupHandle, int ikElementIndex, double linearPrecision, double angularPrecision);
    void oldIkPlugin_setIkElementWeights(int ikGroupHandle, int ikElementIndex, double linearWeight, double angularWeight);
    ...
    int oldIkPlugin_getConfigForTipPose(int ikGroupHandle, int jointCnt, const int* jointHandles, double thresholdDist, int maxIterationsOrTimeInMs, double* retConfig, const double* metric, bool (*validationCallback)(double*), const int* jointOptions, const double* lowLimits, const double* ranges, std::string& errSting);
    int oldIkPlugin_getConfigForTipPose(int ikGroupHandle, int jointCnt, const int* jointHandles, double thresholdDist, int maxIterationsOrTimeInMs, double* retConfig, const double* metric, int collisionPairCnt, const int* collisionPairs, const int* jointOptions, const double* lowLimits, const double* ranges, std::string& errSting);
    CPose oldIkPlugin_getObjectLocalTransformation(int objectHandle);
    void oldIkPlugin_setObjectLocalTransformation(int objectHandle, const CPose& tr);
