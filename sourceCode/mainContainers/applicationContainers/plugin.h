...
typedef void (__cdecl *ptr_oldIkPlugin_setJointInterval)(int ikEnv,int jointHandle,bool cyclic,const double* intervalMinAndRange);
...
typedef void (__cdecl *ptr_oldIkPlugin_setJointDependency)(int ikEnv,int jointHandle,int dependencyJointHandle,double offset,double mult);
...
typedef void (__cdecl *ptr_oldIkPlugin_setSphericalJointQuaternion)(int ikEnv,int jointHandle,const double* quaternion);
...
typedef void (__cdecl *ptr_oldIkPlugin_setIkGroupCalculation)(int ikEnv,int ikGroupHandle,int method,double damping,int maxIterations);
...
typedef void (__cdecl *ptr_oldIkPlugin_setIkElementBase)(int ikEnv,int ikGroupHandle,int ikElementIndex,int baseHandle,int constraintsBaseHandle);
typedef void (__cdecl *ptr_oldIkPlugin_setIkElementConstraints)(int ikEnv,int ikGroupHandle,int ikElementIndex,int constraints);
typedef void (__cdecl *ptr_oldIkPlugin_setIkElementPrecision)(int ikEnv,int ikGroupHandle,int ikElementIndex,double linearPrecision,double angularPrecision);
typedef void (__cdecl *ptr_oldIkPlugin_setIkElementWeights)(int ikEnv,int ikGroupHandle,int ikElementIndex,double linearWeight,double angularWeight);
...
typedef char* (__cdecl *ptr_oldIkPlugin_getConfigForTipPose)(int ikEnv,int ikGroupHandle,int jointCnt,const int* jointHandles,double thresholdDist,int maxIterations,int* result,double* retConfig,const double* metric,bool(*validationCallback)(double*),const int* jointOptions,const double* lowLimits,const double* ranges);
typedef void (__cdecl *ptr_oldIkPlugin_getObjectLocalTransformation)(int ikEnv,int objectHandle,double* pos,double* quat);
typedef void (__cdecl *ptr_oldIkPlugin_setObjectLocalTransformation)(int ikEnv,int objectHandle,const double* pos,const double* quat);
