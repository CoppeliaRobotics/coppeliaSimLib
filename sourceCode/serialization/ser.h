...
class CSer
{
  public:
    ...
    int readOpenBinary(int fileType, bool ignoreTooOldSerializationVersion = false, std::string* infoStr = nullptr,
                       std::string* errorStr = nullptr);
    int readOpenXml(int fileType, bool ignoreTooOldSerializationVersion = false, std::string* infoStr = nullptr,
                    std::string* errorStr = nullptr);
    ...
    void xmlAddNode_binFile(const char* name, const char* localFilenameSuffix, const unsigned char* buff,
                            size_t buffSize);
    CSer* xmlAddNode_binFile(const char* name, const char* localFilenameSuffix);
    void xmlAddNode_imageFile(const char* name, const char* localFilenameSuffix, const unsigned char* img, int resX,
                              int resY, bool rgba);
    void xmlAddNode_meshFile(const char* name, const char* localFilenameSuffix, const float* vertices, int vl,
    ...
    void xmlAddNode_enum(const char* name, int val, std::initializer_list<std::pair<int, const char*>> pairs);
    ...
    void xmlAddNode_3float(const char* name, double val1, double val2, double val3);
    void xmlAddNode_4float(const char* name, double val1, double val2, double val3, double val4);
    void xmlAddNode_floats(const char* name, const float* vals, size_t cnt);
    void xmlAddNode_floats(const char* name, const double* vals, size_t cnt);
    void xmlAddNode_floats(const char* name, const std::vector<float>& vals);
    void xmlAddNode_floats(const char* name, const std::vector<double>& vals);
    ...
    bool xmlGetNode_imageFile(const char* name, std::vector<unsigned char>& image, int* resX = nullptr,
                              int* resY = nullptr, bool* rgba = nullptr, bool required = true);
    bool xmlGetNode_meshFile(const char* name, std::vector<float>& vertices, std::vector<int>& indices,
    ...
    bool xmlGetNode_enum(const char* name, int& val, bool required, std::initializer_list<std::pair<const char*, int>> pairs);
    ...
    bool xmlGetNode_3float(const char* name, double& val1, double& val2, double& val3, bool required = true);
    bool xmlGetNode_4float(const char* name, double& val1, double& val2, double& val3, double& val4,
                           bool required = true);
    bool xmlGetNode_floats(const char* name, float* vals, size_t cnt, bool required = true);
    bool xmlGetNode_floats(const char* name, double* vals, size_t cnt, bool required = true);
    bool xmlGetNode_floats(const char* name, std::vector<float>& vals, bool required = true);
    bool xmlGetNode_floats(const char* name, std::vector<double>& vals, bool required = true);
    bool xmlGetNode_float(const char* name, double& val, bool required = true);
