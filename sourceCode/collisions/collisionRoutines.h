...
public:
    ...
    static bool doEntitiesCollide(int entity1ID,int entity2ID,std::vector<floatDouble>* intersections,bool overrideCollidableFlagIfObject1,bool overrideCollidableFlagIfObject2,int collidingObjectIDs[2]);

private:
    static bool _doesObjectCollideWithObject(CSceneObject* object1,CSceneObject* object2,bool overrideObject1CollidableFlag,bool overrideObject2CollidableFlag,std::vector<floatDouble>* intersections);
    static bool _doesShapeCollideWithShape(CShape* shape1,CShape* shape2,std::vector<floatDouble>* intersections,bool overrideShape1CollidableFlag,bool overrideShape2CollidableFlag);
    ...
    static bool _doesGroupCollideWithShape(const std::vector<CSceneObject*>& group,CShape* shape,std::vector<floatDouble>* intersections,bool overrideShapeCollidableFlag,int& collidingGroupObject);
    ...
    static bool _doesGroupCollideWithItself(const std::vector<CSceneObject*>& group,std::vector<floatDouble>* intersections,int collidingGroupObjects[2]);
    static bool _doesGroupCollideWithGroup(const std::vector<CSceneObject*>& group1,const std::vector<CSceneObject*>& group2,std::vector<floatDouble>* intersections,int collidingGroupObjects[2]);
