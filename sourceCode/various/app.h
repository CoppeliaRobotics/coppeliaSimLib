...
#define DEFINE_PROPERTIES                                                                                                                                                                                                                     \
    ...
    FUNCX(propApp_handle, "handle", sim_propertytype_handle, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, R"===({"label": "Handle", "description": "", "handleType": "app"})===", "") \
    ...
    FUNCX(propApp_plugins, "plugins", sim_propertytype_stringarray, sim_propertyinfo_modelhashexclude, R"===({"label": "App args", "description": ""})===", "")                                                                                                                           \
