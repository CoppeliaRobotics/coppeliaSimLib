...
#define DEFINE_PROPERTIES                                                                                                                                                                                                                     \
    ...
    FUNCX(propApp_objectMetaInfo, "objectMetaInfo", sim_propertytype_string, sim_propertyinfo_silent | sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, "Object meta information", "")                                                                                        \
    FUNCX(propApp_handle, "handle", sim_propertytype_handle, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, "Handle", "") \
    ...
    FUNCX(propApp_consoleVerbosityStr, "consoleVerbosityStr", sim_propertytype_string, sim_propertyinfo_silent | sim_propertyinfo_notreadable | sim_propertyinfo_modelhashexclude, "Console verbosity string", "Console verbosity string, only for client app")         \
    FUNCX(propApp_statusbarVerbosityStr, "statusbarVerbosityStr", sim_propertytype_string, sim_propertyinfo_silent | sim_propertyinfo_notreadable | sim_propertyinfo_modelhashexclude, "Statusbar verbosity string", "Statusbar verbosity string, only for client app") \
    FUNCX(propApp_dialogVerbosityStr, "dialogVerbosityStr", sim_propertytype_string, sim_propertyinfo_silent | sim_propertyinfo_notreadable | sim_propertyinfo_modelhashexclude, "Dialog verbosity string", "Dialog verbosity string, only for client app")             \
    FUNCX(propApp_auxAddOn1, "auxAddOn1", sim_propertytype_string, sim_propertyinfo_silent | sim_propertyinfo_modelhashexclude, "Aux. add-on 1", "Auxiliary add-on 1")             \
    FUNCX(propApp_auxAddOn2, "auxAddOn2", sim_propertytype_string, sim_propertyinfo_silent | sim_propertyinfo_modelhashexclude, "Aux. add-on 2", "Auxiliary add-on 2")             \
    FUNCX(propApp_startupCode, "startupCode", sim_propertytype_string, sim_propertyinfo_silent | sim_propertyinfo_modelhashexclude, "Start-up code", "")             \
    ...
    FUNCX(propApp_machineId, "machineId", sim_propertytype_string, sim_propertyinfo_silent | sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, "Machine ID", "")                                                                                        \
    FUNCX(propApp_legacyMachineId, "legacyMachineId", sim_propertytype_string, sim_propertyinfo_silent | sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude, "Legacy machine ID", "")                                                                     \
