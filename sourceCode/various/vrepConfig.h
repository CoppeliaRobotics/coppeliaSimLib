...
#define SIM_VREP_SCENE_EXTENSION "ttt"
#define SIM_VREP_MODEL_EXTENSION "ttm"
#define SIM_BR_SCENE_EXTENSION "brs"
#define SIM_BR_MODEL_EXTENSION "brm"
#define SIM_MODEL_THUMBNAILFILE_NAME "v_repModelThumbnails.ttmt"
