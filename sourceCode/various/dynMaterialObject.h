...
#define DEFINE_PROPERTIES \
    ...
    FUNCX(propMaterial_bulletNonDefaultCollisionMarginFactor,        "bulletNonDefaultCollisionMarginFactor",           sim_propertytype_float, 0, sim_bullet_body_nondefaultcollisionmargingfactor, -1, -1, -1, -1) \
    FUNCX(propMaterial_bulletNonDefaultCollisionMarginFactorConvex,  "bulletNonDefaultCollisionMarginFactorConvex",     sim_propertytype_float, 0, sim_bullet_body_nondefaultcollisionmargingfactorconvex, -1, -1, -1, -1) \
    FUNCX(propMaterial_bulletSticky,                "bulletSticky",             sim_propertytype_bool,  0, sim_bullet_body_sticky, -1, -1, -1, -1) \
    FUNCX(propMaterial_bulletNonDefaultCollisionMargin,              "bulletNonDefaultCollisionMargin",                 sim_propertytype_bool, 0, sim_bullet_body_usenondefaultcollisionmargin, -1, -1, -1, -1) \
    FUNCX(propMaterial_bulletNonDefaultCollisionMarginConvex,        "bulletNonDefaultCollisionMarginConvex",           sim_propertytype_bool, 0, sim_bullet_body_usenondefaultcollisionmarginconvex, -1, -1, -1, -1) \
    FUNCX(propMaterial_bulletAutoShrinkConvex,       "bulletAutoShrinkConvex",   sim_propertytype_bool,  0, sim_bullet_body_autoshrinkconvex, -1, -1, -1, -1) \
    ...
    FUNCX(propMaterial_vortexPrimaryLinearAxisFriction,  "vortexPrimaryLinearAxisFriction",              sim_propertytype_float, 0, sim_vortex_body_primlinearaxisfriction, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexSecondaryLinearAxisFriction,   "vortexSecondaryLinearAxisFriction",               sim_propertytype_float, 0, sim_vortex_body_seclinearaxisfriction,  -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexPrimaryAngularAxisFriction, "vortexPrimaryAngularAxisFriction",             sim_propertytype_float, 0, sim_vortex_body_primangularaxisfriction,  -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexSecondaryAngularAxisFriction,  "vortexSecondaryAngularAxisFriction",              sim_propertytype_float, 0, sim_vortex_body_secangularaxisfriction,  -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexNormalAngularAxisFriction,"vortexNormalAngularAxisFriction",          sim_propertytype_float, 0, sim_vortex_body_normalangularaxisfriction,  -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexPrimaryLinearAxisStaticFrictionScale,  "vortexPrimaryLinearAxisStaticFrictionScale",              sim_propertytype_float, 0, sim_vortex_body_primlinearaxisstaticfrictionscale, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexSecondaryLinearAxisStaticFrictionScale,   "vortexSecondaryLinearAxisStaticFrictionScale",               sim_propertytype_float, 0, sim_vortex_body_seclinearaxisstaticfrictionscale,  -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexPrimaryAngularAxisStaticFrictionScale, "vortexPrimaryAngularAxisStaticFrictionScale",             sim_propertytype_float, 0, sim_vortex_body_primangularaxisstaticfrictionscale,  -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexSecondaryAngularAxisStaticFrictionScale,  "vortexSecondaryAngularAxisStaticFrictionScale",              sim_propertytype_float, 0, sim_vortex_body_secangularaxisstaticfrictionscale,  -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexNormalAngularAxisStaticFrictionScale,"vortexNormalAngularAxisStaticFrictionScale",          sim_propertytype_float, 0, sim_vortex_body_normalangularaxisstaticfrictionscale,  -1, -1, -1, -1) \
    ...
    FUNCX(propMaterial_vortexLinearVelocityDamping, "vortexLinearVelocityDamping", sim_propertytype_float, 0, sim_vortex_body_linearvelocitydamping, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexAngularVelocityDamping,"vortexAngularVelocityDamping", sim_propertytype_float, 0, sim_vortex_body_angularvelocitydamping, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexPrimaryLinearAxisSlide,"vortexPrimaryLinearAxisSlide", sim_propertytype_float, 0, sim_vortex_body_primlinearaxisslide, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexSecondaryLinearAxisSlide,"vortexSecondaryLinearAxisSlide", sim_propertytype_float, 0, sim_vortex_body_seclinearaxisslide, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexPrimaryAngularAxisSlide,"vortexPrimaryAngularAxisSlide", sim_propertytype_float, 0, sim_vortex_body_primangularaxisslide, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexSecondaryAngularAxisSlide,"vortexSecondaryAngularAxisSlide", sim_propertytype_float, 0, sim_vortex_body_secangularaxisslide, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexNormalAngularAxisSlide,"vortexNormalAngularAxisSlide", sim_propertytype_float, 0, sim_vortex_body_normalangularaxisslide, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexPrimaryLinearAxisSlip,"vortexPrimaryLinearAxisSlip", sim_propertytype_float, 0, sim_vortex_body_primlinearaxisslip, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexSecondaryLinearAxisSlip,"vortexSecondaryLinearAxisSlip", sim_propertytype_float, 0, sim_vortex_body_seclinearaxisslip, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexPrimaryAngularAxisSlip,"vortexPrimaryAngularAxisSlip", sim_propertytype_float, 0, sim_vortex_body_primangularaxisslip, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexSecondaryAngularAxisSlip,"vortexSecondaryAngularAxisSlip", sim_propertytype_float, 0, sim_vortex_body_secangularaxisslip, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexNormalAngularAxisSlip,"vortexNormalAngularAxisSlip", sim_propertytype_float, 0, sim_vortex_body_normalangularaxisslip, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexAutoSleepLinearSpeedThreshold,"vortexAutoSleepLinearSpeedThreshold", sim_propertytype_float, 0, sim_vortex_body_autosleeplinearspeedthreshold, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexAutoSleepLinearAccelerationThreshold,"vortexAutoSleepLinearAccelerationThreshold", sim_propertytype_float, 0, sim_vortex_body_autosleeplinearaccelthreshold, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexAutoSleepAngularSpeedThreshold,"vortexAutoSleepAngularSpeedThreshold", sim_propertytype_float, 0, sim_vortex_body_autosleepangularspeedthreshold, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexAutoSleepAngularAccelerationThreshold,"vortexAutoSleepAngularAccelerationThreshold", sim_propertytype_float, 0, sim_vortex_body_autosleepangularaccelthreshold, -1, -1, -1, -1) \
    ...
    FUNCX(propMaterial_vortexPrimaryAxisVector,"vortexPrimaryAxisVector", sim_propertytype_vector3, 0, sim_vortex_body_primaxisvectorx, sim_vortex_body_primaxisvectory, sim_vortex_body_primaxisvectorz, -1, -1) \
    FUNCX(propMaterial_vortexPrimaryLinearAxisFrictionModel,              "vortexPrimaryLinearAxisFrictionModel",           sim_propertytype_int,   0, sim_vortex_body_primlinearaxisfrictionmodel, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexSecopndaryLinearAxisFrictionModel,           "vortexSecondaryLinearAxisFrictionModel",         sim_propertytype_int,   0, sim_vortex_body_seclinearaxisfrictionmodel, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexPrimaryAngularAxisFrictionModel,             "vortexPrimaryAngularAxisFrictionModel",          sim_propertytype_int,   0, sim_vortex_body_primangulararaxisfrictionmodel, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexSecondaryAngularAxisFrictionModel,           "vortexSecondaryAngularAxisFrictionModel",        sim_propertytype_int,   0, sim_vortex_body_secangularaxisfrictionmodel, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexNormalAngularAxisFrictionModel,              "vortexNormalAngularAxisFrictionModel",           sim_propertytype_int,   0, sim_vortex_body_normalangularaxisfrictionmodel, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexAutoSleepStepLiveThreshold,                  "vortexAutoSleepStepLiveThreshold",               sim_propertytype_int,   0, sim_vortex_body_autosleepsteplivethreshold, -1, -1, -1, -1) \
    ...
    FUNCX(propMaterial_vortexPrimitiveShapesAsConvex,                     "vortexPrimitiveShapesAsConvex",                  sim_propertytype_bool,  0, sim_vortex_body_pureshapesasconvex, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexConvexShapesAsRandom,                        "vortexConvexShapesAsRandom",                     sim_propertytype_bool,  0, sim_vortex_body_convexshapesasrandom, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexRandomShapesAsTerrain,                       "vortexRandomShapesAsTerrain",                    sim_propertytype_bool,  0, sim_vortex_body_randomshapesasterrain, -1, -1, -1, -1) \
    ...
    FUNCX(propMaterial_vortexSecondaryLinearAxisSameAsPrimaryLinearAxis,  "vortexSecondaryLinearAxisSameAsPrimaryLinearAxis", sim_propertytype_bool,  0, sim_vortex_body_seclinaxissameasprimlinaxis, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexSecondaryAngularAxisSameAsPrimaryAngularAxis,"vortexSecondaryAngularAxisSameAsPrimaryAngularAxis", sim_propertytype_bool,  0, sim_vortex_body_secangaxissameasprimangaxis, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexNormalAngularAxisSameAsPrimaryAngularAxis,   "vortexNormalAngularAxisSameAsPrimaryAngularAxis", sim_propertytype_bool,  0, sim_vortex_body_normangaxissameasprimangaxis, -1, -1, -1, -1) \
    FUNCX(propMaterial_vortexAutoAngularDamping,                          "vortexAutoAngularDamping", sim_propertytype_bool,  0, sim_vortex_body_autoangulardamping, -1, -1, -1, -1) \
...
#define FUNCX(name, str, v1, v2, w0, w1, w2, w3, w4) const SEngProperty name = {str, v1, v2, {w0, w1, w2, w3, w4}};
DEFINE_PROPERTIES
#undef FUNCX
#define FUNCX(name, str, v1, v2, w0, w1, w2, w3, w4) name,
const std::vector<SEngProperty> allProps_material = { DEFINE_PROPERTIES };
#undef FUNCX
...
class CDynMaterialObject
{
  public:
    ...
    int setIntVectorProperty(const char* pName, const int* v, int vL, CCbor* eev = nullptr);
  ...
  protected:
    std::string _enumToProperty(int oldEnum, int type, int& indexWithArrays);
