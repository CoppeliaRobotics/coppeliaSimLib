...
#define proptypetag_color "&co4&."
#define proptypetag_color3 "&col&."
...
#define APP_PROPERTIES \
    ...
    FUNCX(platform, "platform", sim_propertytype_enum, sim_propertyinfo_constant | sim_propertyinfo_notwritable,  PropertyInfo({{"label", "OS type"}, {"description", ""}, {"enum", "platform"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    FUNCX(flavor, "flavor", sim_propertytype_enum, sim_propertyinfo_constant | sim_propertyinfo_notwritable,  PropertyInfo({{"label", "Flavor"}, {"description", "Application flavor"}, {"enum", "appFlavor"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    FUNCX(headlessMode, "headlessMode", sim_propertytype_enum, sim_propertyinfo_constant | sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Headless mode"}, {"description", ""}, {"enum", "headlessMode"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    FUNCX(METHOD_loadModelInfo, "loadModelInfo", sim_propertytype_method, SIM_PROPERTYINFO_METHOD,  PropertyInfo({{"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    FUNCX(METHOD_loadModelInfoFromBuffer, "loadModelInfoFromBuffer", sim_propertytype_method, SIM_PROPERTYINFO_METHOD,  PropertyInfo({{"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    FUNCX(METHOD_packArray, "packArray", sim_propertytype_method, SIM_PROPERTYINFO_METHOD,  PropertyInfo({{"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    FUNCX(METHOD_unpackArray, "unpackArray", sim_propertytype_method, SIM_PROPERTYINFO_METHOD,  PropertyInfo({{"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    /* Following for backward compatibility: */ \
    FUNCX(DEPRECATED_dongleID, "dongleID", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,  PropertyInfo({{"replacedBy", "dongleId"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_machineIDX, "machineIDX", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,  PropertyInfo({{"replacedBy", "machineIdX"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_machineID0, "machineID0", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,  PropertyInfo({{"replacedBy", "machineId0"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_machineID1, "machineID1", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,  PropertyInfo({{"replacedBy", "machineId1"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_machineID2, "machineID2", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,  PropertyInfo({{"replacedBy", "machineId2"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_machineID3, "machineID3", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,  PropertyInfo({{"replacedBy", "machineId3"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_appDir, "appPath", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,PropertyInfo({{"replacedBy", "paths.app"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_tempDir, "tempPath", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,PropertyInfo({{"replacedBy", "paths.temp"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_sceneTempDir, "sceneTempPath", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,PropertyInfo({{"replacedBy", "paths.sceneTemp"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_settingsDir, "settingsPath", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,PropertyInfo({{"replacedBy", "paths.settings"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_luaDir, "luaPath", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,PropertyInfo({{"replacedBy", "paths.lua"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_pythonDir, "pythonPath", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,PropertyInfo({{"replacedBy", "paths.python"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_mujocoDir, "mujocoPath", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,PropertyInfo({{"replacedBy", "paths.mujoco"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_systemDir, "systemPath", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,PropertyInfo({{"replacedBy", "paths.system"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_resourceDir, "resourcePath", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,PropertyInfo({{"replacedBy", "paths.resources"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_addOnDir, "addOnPath", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable,PropertyInfo({{"replacedBy", "paths.addOns"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_sceneDir, "scenePath", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_silent,PropertyInfo({{"replacedBy", "paths.scenes"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_modelDir, "modelPath", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_silent,PropertyInfo({{"replacedBy", "paths.models"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_importExportDir, "importExportPath", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_silent,PropertyInfo({{"replacedBy", "paths.importExport"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_appArg1, "appArg1", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_appArg2, "appArg2", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_appArg3, "appArg3", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_appArg4, "appArg4", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_appArg5, "appArg5", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_appArg6, "appArg6", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_appArg7, "appArg7", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_appArg8, "appArg8", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_appArg9, "appArg9", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
...
#define DETACHEDSCRIPT_PROPERTIES \
    ...
    FUNCX(execPriority, "execPriority", sim_propertytype_enum, 0,  PropertyInfo({{"label", "Execution priority"}, {"description", ""}, {"enum", "scriptExecOrder"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    FUNCX(scriptState, "state", sim_propertytype_enum, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "State"}, {"description", "Script state"}, {"enum", "scriptState"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
...
#define DYNCONT_PROPERTIES \
    ...
    FUNCX(dynamicsEngine, DYNAMICSPREFIXDOT "engine", sim_propertytype_enum, 0,  PropertyInfo({{"label", "Dynamics engine"}, {"description", ""}, {"enum", "physicsEngine"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
    FUNCX(dynamicsEngineVersion, DYNAMICSPREFIXDOT "engineVersion",sim_propertytype_int, 0,  PropertyInfo({{"label", "Dynamics engine version"}, {"description", ""}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
    ...
    FUNCX(DEPRECATED_dynamicsEnabled, "dynamicsEnabled", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.enabled"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_showContactPoints, "showContactPoints", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.showContactPoints"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_dynamicsEngine, "dynamicsEngine", sim_propertytype_intarray, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.engine"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_dynamicsStepSize, "dynamicsStepSize", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.stepSize"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_gravity, "gravity", sim_propertytype_vector3, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.gravity"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_engineProperties, "engineProperties", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.engineProperties"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletSolver, BULLETPREFIXDOT "solver", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.bullet.solver"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_global_constraintsolvertype, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletIterations, BULLETPREFIXDOT "iterations", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.bullet.iterations"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_global_constraintsolvingiterations, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletComputeInertias, BULLETPREFIXDOT "computeInertias", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.bullet.computeInertias"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_global_computeinertias, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletInternalScalingFull, BULLETPREFIXDOT "internalScalingFull", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.bullet.internalScalingFull"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_global_fullinternalscaling, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletInternalScalingScaling, BULLETPREFIXDOT "internalScalingValue", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.bullet.internalScalingValue"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_global_internalscalingfactor, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletCollMarginScaling, BULLETPREFIXDOT "collisionMarginScaling", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.bullet.collisionMarginScaling"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_global_collisionmarginfactor, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_odeQuickStepEnabled, ODEPREFIXDOT "quickStepEnabled", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.ode.quickStepEnabled"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_ode_global_quickstep, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_odeQuickStepIterations, ODEPREFIXDOT "quickStepIterations", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.ode.quickStepIterations"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_ode_global_constraintsolvingiterations, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_odeComputeInertias, ODEPREFIXDOT "computeInertias", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.ode.computeInertias"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_ode_global_computeinertias, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_odeInternalScalingFull, ODEPREFIXDOT "internalScalingFull", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.ode.internalScalingFull"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_ode_global_fullinternalscaling, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_odeInternalScalingScaling, ODEPREFIXDOT "internalScalingValue", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.ode.internalScalingValue"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_ode_global_internalscalingfactor, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_odeGlobalErp, ODEPREFIXDOT "globalErp", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.ode.globalErp"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_ode_global_erp, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_odeGlobalCfm, ODEPREFIXDOT "globalCfm", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.ode.globalCfm"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_ode_global_cfm, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexComputeInertias, VORTEXPREFIXDOT "computeInertias", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.vortex.computeInertias"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_global_computeinertias, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexContactTolerance, VORTEXPREFIXDOT "contactTolerance", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.vortex.contactTolerance"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_global_contacttolerance, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexAutoSleep, VORTEXPREFIXDOT "autoSleep", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.vortex.autoSleep"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_global_autosleep, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexMultithreading, VORTEXPREFIXDOT "multithreading", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.vortex.multithreading"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_global_multithreading, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexConstraintsLinearCompliance, VORTEXPREFIXDOT "constraintsLinearCompliance", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.vortex.constraintsLinearCompliance"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_global_constraintlinearcompliance, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexConstraintsLinearDamping, VORTEXPREFIXDOT "constraintsLinearDamping", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.vortex.constraintsLinearDamping"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_global_constraintlineardamping, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexConstraintsLinearKineticLoss, VORTEXPREFIXDOT "constraintsLinearKineticLoss", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.vortex.constraintsLinearKineticLoss"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_global_constraintlinearkineticloss, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexConstraintsAngularCompliance, VORTEXPREFIXDOT "constraintsAngularCompliance", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.vortex.constraintsAngularCompliance"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_global_constraintangularcompliance, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexConstraintsAngularDamping, VORTEXPREFIXDOT "constraintsAngularDamping", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.vortex.constraintsAngularDamping"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_global_constraintangulardamping, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexConstraintsAngularKineticLoss, VORTEXPREFIXDOT "constraintsAngularKineticLoss", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.vortex.constraintsAngularKineticLoss"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_global_constraintangularkineticloss, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_newtonIterations, NEWTONPREFIXDOT "iterations", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.newton.iterations"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_newton_global_constraintsolvingiterations, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_newtonComputeInertias, NEWTONPREFIXDOT "computeInertias", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.newton.computeInertias"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_newton_global_computeinertias, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_newtonMultithreading, NEWTONPREFIXDOT "multithreading", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.newton.multithreading"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_newton_global_multithreading, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_newtonExactSolver, NEWTONPREFIXDOT "exactSolver", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.newton.exactSolver"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_newton_global_exactsolver, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_newtonHighJointAccuracy, NEWTONPREFIXDOT "highJointAccuracy", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.newton.highJointAccuracy"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_newton_global_highjointaccuracy, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_newtonContactMergeTolerance, NEWTONPREFIXDOT "contactMergeTolerance", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.newton.contactMergeTolerance"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_newton_global_contactmergetolerance, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoIntegrator, MUJOCOPREFIXDOT "integrator", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.integrator"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_integrator, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoSolver, MUJOCOPREFIXDOT "solver", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.solver"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_solver, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoIterations, MUJOCOPREFIXDOT "iterations", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.iterations"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_iterations, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoRebuildTrigger, MUJOCOPREFIXDOT "rebuildTrigger", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.rebuildTrigger"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_rebuildtrigger, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoComputeInertias, MUJOCOPREFIXDOT "computeInertias", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.computeInertias"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_computeinertias, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoMbMemory, MUJOCOPREFIXDOT "mbmemory", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.mbmemory"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoNjMax, MUJOCOPREFIXDOT "njmax", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.njmax"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_njmax, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoNconMax, MUJOCOPREFIXDOT "nconmax", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.nconmax"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_nconmax, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoNstack, MUJOCOPREFIXDOT "nstack", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.nstack"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_nstack, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoCone, MUJOCOPREFIXDOT "cone", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.cone"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_cone, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoKinematicBodiesOverrideFlags, MUJOCOPREFIXDOT "kinematicBodiesOverrideFlags", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.kinematicBodiesOverrideFlags"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_overridekin, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoKinematicBodiesMass, MUJOCOPREFIXDOT "kinematicBodiesMass", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.kinematicBodiesMass"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_kinmass, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoKinematicBodiesInertia, MUJOCOPREFIXDOT "kinematicBodiesInertia", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.kinematicBodiesInertia"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_kininertia, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoBoundMass, MUJOCOPREFIXDOT "boundMass", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.boundMass"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_boundmass, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoBoundInertia, MUJOCOPREFIXDOT "boundInertia", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.boundInertia"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_boundinertia, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoBalanceInertias, MUJOCOPREFIXDOT "balanceInertias", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.balanceInertias"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_balanceinertias, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoMultithreaded, MUJOCOPREFIXDOT "multithreaded", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.multithreaded"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_multithreaded, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoMulticcd, MUJOCOPREFIXDOT "multiccd", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.multiccd"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_multiccd, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoContactParamsOverride, MUJOCOPREFIXDOT "contactParamsOverride", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.contactParamsOverride"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_overridecontacts, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoContactParamsMargin, MUJOCOPREFIXDOT "contactParamsMargin", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.contactParamsMargin"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_overridemargin, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoContactParamsSolref, MUJOCOPREFIXDOT "contactParamsSolref", sim_propertytype_floatarray, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.contactParamsSolref"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_overridesolref1, sim_mujoco_global_overridesolref2, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoContactParamsSolimp, MUJOCOPREFIXDOT "contactParamsSolimp", sim_propertytype_floatarray, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.contactParamsSolimp"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_overridesolimp1, sim_mujoco_global_overridesolimp2, sim_mujoco_global_overridesolimp3, sim_mujoco_global_overridesolimp4, sim_mujoco_global_overridesolimp5) \
    FUNCX(DEPRECATED_mujocoImpRatio, MUJOCOPREFIXDOT "impratio", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.impratio"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_impratio, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoWind, MUJOCOPREFIXDOT "wind", sim_propertytype_vector3, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.wind"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_wind1, sim_mujoco_global_wind2, sim_mujoco_global_wind3, -1, -1) \
    FUNCX(DEPRECATED_mujocoDensity, MUJOCOPREFIXDOT "density", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.density"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_density, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoViscosity, MUJOCOPREFIXDOT "viscosity", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.viscosity"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_global_viscosity, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoJacobian, MUJOCOPREFIXDOT "jacobian", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.jacobian"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoTolerance, MUJOCOPREFIXDOT "tolerance", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.tolerance"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoLs_iterations, MUJOCOPREFIXDOT "ls_iterations", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.ls_iterations"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoLs_tolerance, MUJOCOPREFIXDOT "ls_tolerance", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.ls_tolerance"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoNoslip_iterations, MUJOCOPREFIXDOT "noslip_iterations", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.noslip_iterations"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoNoslip_tolerance, MUJOCOPREFIXDOT "noslip_tolerance", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.noslip_tolerance"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoCcd_iterations, MUJOCOPREFIXDOT "ccd_iterations", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.ccd_iterations"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoCcd_tolerance, MUJOCOPREFIXDOT "ccd_tolerance", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.ccd_tolerance"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoSdf_iterations, MUJOCOPREFIXDOT "sdf_iterations", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.sdf_iterations"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoSdf_initpoints, MUJOCOPREFIXDOT "sdf_initpoints", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.sdf_initpoints"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoEqualityEnable, MUJOCOPREFIXDOT "equalityEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.equalityEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoFrictionlossEnable, MUJOCOPREFIXDOT "frictionlossEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.frictionlossEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoLimitEnable, MUJOCOPREFIXDOT "limitEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.limitEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoContactEnable, MUJOCOPREFIXDOT "contactEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.contactEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoPassiveEnable, MUJOCOPREFIXDOT "passiveEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.passiveEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoGravityEnable, MUJOCOPREFIXDOT "gravityEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.gravityEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoWarmstartEnable, MUJOCOPREFIXDOT "warmstartEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.warmstartEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoActuationEnable, MUJOCOPREFIXDOT "actuationEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.actuationEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoRefsafeEnable, MUJOCOPREFIXDOT "refsafeEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.refsafeEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoSensorEnable, MUJOCOPREFIXDOT "sensorEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.sensorEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoMidphaseEnable, MUJOCOPREFIXDOT "midphaseEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.midphaseEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoEulerdampEnable, MUJOCOPREFIXDOT "eulerdampEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.eulerdampEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoAutoresetEnable, MUJOCOPREFIXDOT "autoresetEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.autoresetEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoEnergyEnable, MUJOCOPREFIXDOT "energyEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.energyEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoInvdiscreteEnable, MUJOCOPREFIXDOT "invdiscreteEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.invdiscreteEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoNativeccdEnable, MUJOCOPREFIXDOT "nativeccdEnable", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.nativeccdEnable"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoAlignfree, MUJOCOPREFIXDOT "alignfree", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.alignfree"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoKinematicWeldSolref, MUJOCOPREFIXDOT "kinematicWeldSolref", sim_propertytype_floatarray, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.kinematicWeldSolref"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoKinematicWeldSolimp, MUJOCOPREFIXDOT "kinematicWeldSolimp", sim_propertytype_floatarray, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.kinematicWeldSolimp"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoKinematicWeldTorqueScale, MUJOCOPREFIXDOT "kinematicWeldTorquescale", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"replacedBy", "dynamics.mujoco.kinematicWeldTorquescale"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
...
#define SCENE_PROPERTIES \
    ...
    /* Following for backward compatibility: */ \
    FUNCX(DEPRECATED_sceneIsLocked, "sceneIsLocked", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable, PropertyInfo({{"replacedBy", "locked"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_sceneUid, "sceneUid", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable, PropertyInfo({{"replacedBy", "uid"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_sceneUidString, "sceneUidString", sim_propertytype_string,SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_constant | sim_propertyinfo_notwritable, PropertyInfo({{"replacedBy", "uidString"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_scenePath, "scenePath", sim_propertytype_string, SIM_PROPERTYINFO_DEPRECATED, PropertyInfo({{"replacedBy", "path"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
...
#define SIMULATION_PROPERTIES \
    ...
    FUNCX(simulationState, SIMULATIONPREFIXDOT "state", sim_propertytype_enum, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Simulation state"}, {"description", ""}, {"enum", "simulationState"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    /* Following for backward compatibility: */ \
    FUNCX(DEPRECATED_removeNewObjectsAtEnd, "removeNewObjectsAtEnd", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,PropertyInfo({{"replacedBy", "simulation.removeNewObjects"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_realtimeSimulation, "realtimeSimulation", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,PropertyInfo({{"replacedBy", "simulation.realtime"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_pauseSimulationAtTime, "pauseSimulationAtTime", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,PropertyInfo({{"replacedBy", "simulation.pauseAtTime"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_pauseSimulationAtError, "pauseSimulationAtError", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,PropertyInfo({{"replacedBy", "simulation.pauseAtError"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_simulationTime, "simulationTime", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable,PropertyInfo({{"replacedBy", "simulation.time"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_timeStep, "timeStep", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,PropertyInfo({{"replacedBy", "simulation.timeStep"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_timeToPause, "timeToPause", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,PropertyInfo({{"replacedBy", "simulation.timeToPause"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_realtimeModifier, "realtimeModifier", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,PropertyInfo({{"replacedBy", "simulation.realtimeModifier"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_stepCount, "stepCount", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable,PropertyInfo({{"replacedBy", "simulation.stepCount"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_simulationState, "simulationState", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable,PropertyInfo({{"replacedBy", "simulation.state"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_stepsPerRendering, "stepsPerRendering", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,PropertyInfo({{"replacedBy", "simulation.stepsPerRendering"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_speedModifier, "speedModifier", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,PropertyInfo({{"replacedBy", "simulation.speedModifier"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}))
...
#define MESH_PROPERTIES \
    ...
    FUNCX(textureApplyMode, TEXTUREPREFIXDOT "applyMode", sim_propertytype_enum, 0,  PropertyInfo({{"label", "Texture apply mode"}, {"description", ""}, {"enum", "textureApplyMode"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    FUNCX(primitiveType, "primitive", sim_propertytype_enum, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Primitive type"}, {"description", ""}, {"enum", "primitiveType"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    /* Following for backward compatibility: */ \
    FUNCX(DEPRECATED_primitiveType, "primitiveType", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable, PropertyInfo({{"replacedBy", "primitive"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_textureResolution, "textureResolution", sim_propertytype_intarray2, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable, PropertyInfo({{"replacedBy", "texture.resolution"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_textureCoordinates, "textureCoordinates", sim_propertytype_floatarray, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable, PropertyInfo({{"replacedBy", "texture.coordinates"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_textureApplyMode, "textureApplyMode", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED, PropertyInfo({{"replacedBy", "texture.applyMode"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_textureRepeatU, "textureRepeatU", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED, PropertyInfo({{"replacedBy", "texture.repeatU"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_textureRepeatV, "textureRepeatV", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED, PropertyInfo({{"replacedBy", "texture.repeatV"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_textureInterpolate, "textureInterpolate", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED, PropertyInfo({{"replacedBy", "texture.interpolate"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_texture, "rawTexture", sim_propertytype_buffer, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable, PropertyInfo({{"replacedBy", "texture.data"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_textureID, "textureID", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable, PropertyInfo({{"replacedBy", "texture.id"}, {"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
...
#define DYNMATERIAL_PROPERTIES \
    ...
    FUNCX(DEPRECATED_bulletRestitution, BULLETPREFIXDOT "restitution", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_body_restitution, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletFriction0, BULLETPREFIXDOT "frictionOld", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_body_oldfriction, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletFriction, BULLETPREFIXDOT "friction", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_body_friction, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletLinearDamping, BULLETPREFIXDOT "linearDamping", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_body_lineardamping, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletAngularDamping, BULLETPREFIXDOT "angularDamping", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_body_angulardamping, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletNonDefaultCollisionMarginFactor, BULLETPREFIXDOT "customCollisionMarginValue", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_body_nondefaultcollisionmargingfactor, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletNonDefaultCollisionMarginFactorConvex, BULLETPREFIXDOT "customCollisionMarginConvexValue", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_body_nondefaultcollisionmargingfactorconvex, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletSticky, BULLETPREFIXDOT "stickyContact", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_body_sticky, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletNonDefaultCollisionMargin, BULLETPREFIXDOT "customCollisionMarginEnabled", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_body_usenondefaultcollisionmargin, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletNonDefaultCollisionMarginConvex, BULLETPREFIXDOT "customCollisionMarginConvexEnabled", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_body_usenondefaultcollisionmarginconvex, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_bulletAutoShrinkConvex, BULLETPREFIXDOT "autoShrinkConvexMeshes", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_bullet_body_autoshrinkconvex, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_odeFriction, ODEPREFIXDOT "friction", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_ode_body_friction, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_odeSoftErp, ODEPREFIXDOT "softErp", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_ode_body_softerp, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_odeSoftCfm, ODEPREFIXDOT "softCfm", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_ode_body_softcfm, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_odeLinearDamping, ODEPREFIXDOT "linearDamping", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_ode_body_lineardamping, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_odeAngularDamping, ODEPREFIXDOT "angularDamping", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_ode_body_angulardamping, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_odeMaxContacts, ODEPREFIXDOT "maxContacts", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_ode_body_maxcontacts, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexPrimaryLinearAxisFriction, VORTEXPREFIXDOT "linearPrimaryAxisFrictionValue", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_primlinearaxisfriction, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexSecondaryLinearAxisFriction, VORTEXPREFIXDOT "linearSecondaryAxisFrictionValue", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_seclinearaxisfriction, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexPrimaryAngularAxisFriction, VORTEXPREFIXDOT "angularPrimaryAxisFrictionValue", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_primangularaxisfriction, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexSecondaryAngularAxisFriction, VORTEXPREFIXDOT "angularSecondaryAxisFrictionValue", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_secangularaxisfriction, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexNormalAngularAxisFriction, VORTEXPREFIXDOT "angularNormalAxisFrictionValue", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_normalangularaxisfriction, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexPrimaryLinearAxisStaticFrictionScale, VORTEXPREFIXDOT "linearPrimaryAxisStaticFrictionScale", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_primlinearaxisstaticfrictionscale, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexSecondaryLinearAxisStaticFrictionScale, VORTEXPREFIXDOT "linearSecondaryAxisStaticFrictionScale", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_seclinearaxisstaticfrictionscale, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexPrimaryAngularAxisStaticFrictionScale, VORTEXPREFIXDOT "angularPrimaryAxisStaticFrictionScale", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_primangularaxisstaticfrictionscale, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexSecondaryAngularAxisStaticFrictionScale, VORTEXPREFIXDOT "angularSecondaryAxisStaticFrictionScale", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_secangularaxisstaticfrictionscale, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexNormalAngularAxisStaticFrictionScale, VORTEXPREFIXDOT "angularNormalAxisStaticFrictionScale", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_normalangularaxisstaticfrictionscale, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexCompliance, VORTEXPREFIXDOT "compliance", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_compliance, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexDamping, VORTEXPREFIXDOT "damping", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_damping, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexRestitution, VORTEXPREFIXDOT "restitution", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_restitution, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexRestitutionThreshold, VORTEXPREFIXDOT "restitutionThreshold", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_restitutionthreshold, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexAdhesiveForce, VORTEXPREFIXDOT "adhesiveForce", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_adhesiveforce, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexLinearVelocityDamping, VORTEXPREFIXDOT "linearVelDamping", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_linearvelocitydamping, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexAngularVelocityDamping, VORTEXPREFIXDOT "angularVelDamping", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_angularvelocitydamping, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexPrimaryLinearAxisSlide, VORTEXPREFIXDOT "linearPrimaryAxisSlide", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_primlinearaxisslide, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexSecondaryLinearAxisSlide, VORTEXPREFIXDOT "linearSecondaryAxisSlide", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_seclinearaxisslide, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexPrimaryAngularAxisSlide, VORTEXPREFIXDOT "angularPrimaryAxisSlide", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_primangularaxisslide, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexSecondaryAngularAxisSlide, VORTEXPREFIXDOT "angularSecondaryAxisSlide", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_secangularaxisslide, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexNormalAngularAxisSlide, VORTEXPREFIXDOT "angularNormalAxisSlide", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_normalangularaxisslide, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexPrimaryLinearAxisSlip, VORTEXPREFIXDOT "linearPrimaryAxisSlip", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_primlinearaxisslip, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexSecondaryLinearAxisSlip, VORTEXPREFIXDOT "linearSecondaryAxisSlip", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_seclinearaxisslip, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexPrimaryAngularAxisSlip, VORTEXPREFIXDOT "angularPrimaryAxisSlip", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_primangularaxisslip, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexSecondaryAngularAxisSlip, VORTEXPREFIXDOT "angularSecondaryAxisSlip", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_secangularaxisslip, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexNormalAngularAxisSlip, VORTEXPREFIXDOT "angularNormalAxisSlip", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_normalangularaxisslip, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexAutoSleepLinearSpeedThreshold, VORTEXPREFIXDOT "autoSleepThresholdLinearSpeed", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_autosleeplinearspeedthreshold, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexAutoSleepLinearAccelerationThreshold, VORTEXPREFIXDOT "autoSleepThresholdLinearAccel", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_autosleeplinearaccelthreshold, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexAutoSleepAngularSpeedThreshold, VORTEXPREFIXDOT "autoSleepThresholdAngularSpeed", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_autosleepangularspeedthreshold, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexAutoSleepAngularAccelerationThreshold, VORTEXPREFIXDOT "autoSleepThresholdAngularAccel", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_autosleepangularaccelthreshold, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexSkinThickness, VORTEXPREFIXDOT "skinThickness", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_skinthickness, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexAutoAngularDampingTensionRatio, VORTEXPREFIXDOT "autoAngularDampingTensionRatio", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_autoangulardampingtensionratio, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexPrimaryAxisVector, VORTEXPREFIXDOT "linearPrimaryValue", sim_propertytype_vector3, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_primaxisvectorx, sim_vortex_body_primaxisvectory, sim_vortex_body_primaxisvectorz, -1, -1) \
    FUNCX(DEPRECATED_vortexPrimaryLinearAxisFrictionModel, VORTEXPREFIXDOT "linearPrimaryAxisFrictionModel", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_primlinearaxisfrictionmodel, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexSecondaryLinearAxisFrictionModel, VORTEXPREFIXDOT "linearSecondaryAxisFrictionModel", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_seclinearaxisfrictionmodel, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexPrimaryAngularAxisFrictionModel, VORTEXPREFIXDOT "angularPrimaryAxisFrictionModel", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_primangulararaxisfrictionmodel, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexSecondaryAngularAxisFrictionModel, VORTEXPREFIXDOT "angularSecondaryAxisFrictionModel", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_secangularaxisfrictionmodel, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexNormalAngularAxisFrictionModel, VORTEXPREFIXDOT "angularNormalAxisFrictionModel", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_normalangularaxisfrictionmodel, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexAutoSleepStepLiveThreshold, VORTEXPREFIXDOT "autoSleepThresholdSteps", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_autosleepsteplivethreshold, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexMaterialUniqueId, VORTEXPREFIXDOT "materialUniqueId", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_materialuniqueid, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexPrimitiveShapesAsConvex, VORTEXPREFIXDOT "primitiveAsConvex", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_pureshapesasconvex, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexConvexShapesAsRandom, VORTEXPREFIXDOT "convexAsRandom", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_convexshapesasrandom, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexRandomShapesAsTerrain, VORTEXPREFIXDOT "randomAsTerrain", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_randomshapesasterrain, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexFastMoving, VORTEXPREFIXDOT "fastMoving", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_fastmoving, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexAutoSlip, VORTEXPREFIXDOT "autoSlip", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_autoslip, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexSecondaryLinearAxisSameAsPrimaryLinearAxis, VORTEXPREFIXDOT "linearSecondaryAxisFollowPrimaryAxis", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_seclinaxissameasprimlinaxis, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexSecondaryAngularAxisSameAsPrimaryAngularAxis, VORTEXPREFIXDOT "angularSecondaryAxisFollowPrimaryAxis", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_secangaxissameasprimangaxis, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexNormalAngularAxisSameAsPrimaryAngularAxis, VORTEXPREFIXDOT "angularNormalAxisFollowPrimaryAxis", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_normangaxissameasprimangaxis, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_vortexAutoAngularDamping, VORTEXPREFIXDOT "autoAngularDampingEnabled", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_vortex_body_autoangulardamping, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_newtonStaticFriction, NEWTONPREFIXDOT "staticFriction", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_newton_body_staticfriction, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_newtonKineticFriction, NEWTONPREFIXDOT "kineticFriction", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_newton_body_kineticfriction, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_newtonRestitution, NEWTONPREFIXDOT "restitution", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_newton_body_restitution, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_newtonLinearDrag, NEWTONPREFIXDOT "linearDrag", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_newton_body_lineardrag, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_newtonAngularDrag, NEWTONPREFIXDOT "angularDrag", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_newton_body_angulardrag, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_newtonFastMoving, NEWTONPREFIXDOT "fastMoving", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_newton_body_fastmoving, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoFriction, MUJOCOPREFIXDOT "friction", sim_propertytype_floatarray, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_body_friction1, sim_mujoco_body_friction2, sim_mujoco_body_friction3, -1, -1) \
    FUNCX(DEPRECATED_mujocoSolref, MUJOCOPREFIXDOT "solref", sim_propertytype_floatarray, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_body_solref1, sim_mujoco_body_solref2, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoSolimp, MUJOCOPREFIXDOT "solimp", sim_propertytype_floatarray, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_body_solimp1, sim_mujoco_body_solimp2, sim_mujoco_body_solimp3, sim_mujoco_body_solimp4, sim_mujoco_body_solimp5) \
    FUNCX(DEPRECATED_mujocoSolmix, MUJOCOPREFIXDOT "solmix", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_body_solmix, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoMargin, MUJOCOPREFIXDOT "margin", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_body_margin, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoGap, MUJOCOPREFIXDOT "gap", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoCondim, MUJOCOPREFIXDOT "condim", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_body_condim, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoPriority, MUJOCOPREFIXDOT "priority", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  sim_mujoco_body_priority, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoAdhesion, MUJOCOPREFIXDOT "adhesion", sim_propertytype_bool, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoAdhesionGain, MUJOCOPREFIXDOT "adhesiongain", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoAdhesionForcelimited, MUJOCOPREFIXDOT "adhesionforcelimited", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoAdhesionCtrlrange, MUJOCOPREFIXDOT "adhesionctrlrange", sim_propertytype_floatarray, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoAdhesionForcerange, MUJOCOPREFIXDOT "adhesionforcerange", sim_propertytype_floatarray, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoAdhesionCtrl, MUJOCOPREFIXDOT "adhesionctrl", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_mujocoGravcomp, MUJOCOPREFIXDOT "gravcomp", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
...
#define SCENEOBJECT_PROPERTIES \
    ...
    FUNCX(calcLinearVelocity, "linearVelocity", sim_propertytype_vector3, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Linear velocity"}, {"description", "Calculated scene object linear velocity vector"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    FUNCX(calcAngularVelocity, "angularVelocity", sim_propertytype_vector3, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Angular velocity"}, {"description", "Calculated scene object angular velocity vector"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    FUNCX(METHOD_getObject, "getObject", sim_propertytype_method, SIM_PROPERTYINFO_METHOD,  PropertyInfo({{"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    /* Following for backward compatibility: */ \
    FUNCX(DEPRECATED_calcLinearVelocity, "calcLinearVelocity", sim_propertytype_vector3, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_calcRotationAxis, "calcRotationAxis", sim_propertytype_vector3, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_calcRotationVelocity, "calcRotationVelocity", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
...
#define SHAPE_PROPERTIES \
    ...
    FUNCX(dynLinearVelocity, DYNAMICSPREFIXDOT "linearVelocity", sim_propertytype_vector3, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Linear velocity"}, {"description", "Linear velocity, as transmitted by the physics engine"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    FUNCX(dynAngularVelocity, DYNAMICSPREFIXDOT "angularVelocity", sim_propertytype_vector3, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Rotational velocity"}, {"description", "Rotational velocity, as transmitted by the physics engine"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    /* Following for backward compatibility: */ \
    FUNCX(DEPRECATED_dynLinearVelocity, "dynLinearVelocity", sim_propertytype_vector3, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
    FUNCX(DEPRECATED_dynAngularVelocity, "dynAngularVelocity", sim_propertytype_vector3, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
...
#define FORCESENSOR_PROPERTIES \
    ...
    FUNCX(filterType, "filter", sim_propertytype_enum, 0,  PropertyInfo({{"label", "Filter"}, {"description", "Filter type"}, {"enum", "forceSensorFilter"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    /* Following for backward compatibility: */ \
    FUNCX(DEPRECATED_filterType, "filterType", sim_propertytype_int, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
...
#define JOINT_PROPERTIES \
    ...
    FUNCX(configuration, "configuration", sim_propertytype_floatarray, sim_propertyinfo_silent,  PropertyInfo({{"label", "Configuration"}, {"description", "Joint configuration"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
    ...
    FUNCX(calcVelocity, "velocity", sim_propertytype_float, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Velocity"}, {"description", "Calculated joint linear or angular velocity"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
    ...
    FUNCX(bounds, "bounds", sim_propertytype_floatarray, 0,  PropertyInfo({{"label", "Bounds"}, {"description", "Joint lower and upper bounds"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
    ...
    FUNCX(jointMode, "mode", sim_propertytype_enum, 0,  PropertyInfo({{"label", "Mode"}, {"description", "Joint mode"}, {"enum", "jointMode"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
    ...
    FUNCX(dynCtrlMode, DYNAMICSPREFIXDOT "ctrlMode", sim_propertytype_enum, 0, PropertyInfo({{"label", "Control mode" }, {"description", "Joint control mode, when in dynamic mode"}, {"enum", "jointDynamicsCtrlMode"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
    ...
    FUNCX(dynSmoothMotionProfile, DYNAMICSPREFIXDOT "smoothMotionProfile", sim_propertytype_bool, 0,  PropertyInfo({{"label", "Smooth dynamics motion profile"}, {"description", ""}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
    FUNCX(engineProperties, DYNAMICSPREFIXDOT "engineProperties", sim_propertytype_string, sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Engine properties"}, {"description", "Engine properties as JSON text"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
    ...
    FUNCX(DEPRECATEDGROUP_dynamicsVortex, VORTEXPREFIX, sim_propertytype_group, SIM_PROPERTYINFO_GROUP | SIM_PROPERTYINFO_DEPRECATED, PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATEDGROUP_dynamicsMujoco, MUJOCOPREFIX, sim_propertytype_group, SIM_PROPERTYINFO_GROUP | SIM_PROPERTYINFO_DEPRECATED, PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_interval, "interval", sim_propertytype_floatarray, SIM_PROPERTYINFO_DEPRECATED,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
    FUNCX(DEPRECATED_calcVelocity, "calcVelocity", sim_propertytype_float, SIM_PROPERTYINFO_DEPRECATED | sim_propertyinfo_notwritable,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}}),  -1, -1, -1, -1, -1) \
...
#define VISIONSENSOR_PROPERTIES \
    ...
    FUNCX(renderMode, "renderMode", sim_propertytype_enum, 0,  PropertyInfo({{"label", "Render mode"}, {"description", ""}, {"enum", "renderMode"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
...
#define MARKER_PROPERTIES \
    ...
    FUNCX(type, "marker.type", sim_propertytype_string, sim_propertyinfo_constant | sim_propertyinfo_notwritable,  PropertyInfo({{"label", "Type"}, {"description", "Marker type"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    FUNCX(defaultItemSize, "defaultItemSize", sim_propertytype_vector3, sim_propertyinfo_constant | sim_propertyinfo_notwritable,  PropertyInfo({{"label", "Default size"}, {"description", ""}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
