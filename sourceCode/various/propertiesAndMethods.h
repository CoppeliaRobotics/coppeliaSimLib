...
#define APP_PROPERTIES \
    ...
    FUNCX(platform, "platform", sim_propertytype_enum, sim_propertyinfo_constant | sim_propertyinfo_notwritable,  PropertyInfo({{"label", "OS type"}, {"description", ""}, {"enum", "SimPlatform"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    FUNCX(flavor, "flavor", sim_propertytype_enum, sim_propertyinfo_constant | sim_propertyinfo_notwritable,  PropertyInfo({{"label", "Flavor"}, {"description", "Application flavor"}, {"enum", "SimAppFlavor"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    FUNCX(headlessMode, "headlessMode", sim_propertytype_enum, sim_propertyinfo_constant | sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Headless mode"}, {"description", ""}, {"enum", "simHeadlessMode"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
...
#define DETACHEDSCRIPT_PROPERTIES \
    ...
    FUNCX(execPriority, "execPriority", sim_propertytype_enum, 0,  PropertyInfo({{"label", "Execution priority"}, {"description", ""}, {"enum", "SimScriptExecOrder"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    FUNCX(scriptState, "state", sim_propertytype_enum, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "State"}, {"description", "Script state"}, {"enum", "SimScriptState"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
...
#define DYNCONT_PROPERTIES \
    ...
    FUNCX(dynamicsEngine, DYNAMICSPREFIXDOT "engine", sim_propertytype_enum, 0,  PropertyInfo({{"label", "Dynamics engine"}, {"description", ""}, {"enum", "SimPhysicsEngine"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
...
#define SIMULATION_PROPERTIES \
    ...
    FUNCX(simulationState, SIMULATIONPREFIXDOT "state", sim_propertytype_enum, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Simulation state"}, {"description", ""}, {"enum", "SimSimulationState"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
...
#define MESH_PROPERTIES \
    ...
    FUNCX(textureApplyMode, TEXTUREPREFIXDOT "applyMode", sim_propertytype_enum, 0,  PropertyInfo({{"label", "Texture apply mode"}, {"description", ""}, {"enum", "SimTextureApplyMode"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    FUNCX(primitiveType, "primitive", sim_propertytype_enum, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Primitive type"}, {"description", ""}, {"enum", "SimPrimitiveType"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
...
#define FORCESENSOR_PROPERTIES \
    ...
    FUNCX(filterType, "filter", sim_propertytype_enum, 0,  PropertyInfo({{"label", "Filter"}, {"description", "Filter type"}, {"enum", "SimForceSensorFilter"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    ...
    /* Following for backward compatibility: */ \
    FUNCX(DEPRECATED_filterType, "filterType", sim_propertytype_int, 0,  PropertyInfo({{"startSupport", 1}, {"startDeprecated", 2}, {"endSupport", 2}})) \
...
#define JOINT_PROPERTIES \
    ...
    FUNCX(jointMode, "mode", sim_propertytype_enum, 0,  PropertyInfo({{"label", "Mode"}, {"description", "Joint mode"}, {"enum", "SimJointMode"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
    ...
    FUNCX(dynCtrlMode, DYNAMICSPREFIXDOT "ctrlMode", sim_propertytype_enum, 0, PropertyInfo({{"label", "Control mode" }, {"description", "Joint control mode, when in dynamic mode"}, {"enum", "SimJointDynamicsCtrlMode"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
    ...
    FUNCX(dynVelMode, DYNAMICSPREFIXDOT "velMode", sim_propertytype_enum, 0,  PropertyInfo({{"label", "Dynamic velocity mode"}, {"description", "Dynamic velocity mode (0: default, 1: Ruckig)"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
    FUNCX(dynPosMode, DYNAMICSPREFIXDOT "posMode", sim_propertytype_enum, 0,  PropertyInfo({{"label", "Dynamic position mode"}, {"description", "Dynamic position mode (0: default, 1: Ruckig)"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
    FUNCX(engineProperties, DYNAMICSPREFIXDOT "engineProperties", sim_propertytype_string, sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Engine properties"}, {"description", "Engine properties as JSON text"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}}),  -1, -1, -1, -1, -1) \
...
#define VISIONSENSOR_PROPERTIES \
    ...
    FUNCX(renderMode, "renderMode", sim_propertytype_enum, 0,  PropertyInfo({{"label", "Render mode"}, {"description", ""}, {"enum", "SimRenderMode"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
