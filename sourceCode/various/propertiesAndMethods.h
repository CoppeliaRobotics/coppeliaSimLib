...
#define SCENEOBJECT_PROPERTIES \
    ...
    FUNCX(calcRotationAxis, "rotationAxis", sim_propertytype_vector3, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Rotation axis"}, {"description", "Calculated scene object rotation axis"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
    FUNCX(calcRotationVelocity, "rotationVelocity", sim_propertytype_float, sim_propertyinfo_notwritable | sim_propertyinfo_modelhashexclude,  PropertyInfo({{"label", "Rotation velocity"}, {"description", "Calculated scene object rotation velocity"}, {"startSupport", 2}, {"startDeprecated", 0}, {"endSupport", 0}})) \
