...
class CAnnJson
{
  public:
    ...
    static bool getValue(QJsonObject &jsonObj, const char *key, QJsonValue::Type type, QJsonValue &value,
                         std::string *errMsg = nullptr);
    static bool getValue(QJsonObject &jsonObj, const char *key, double *vals, size_t cnt,
                         std::string *errMsg = nullptr);
