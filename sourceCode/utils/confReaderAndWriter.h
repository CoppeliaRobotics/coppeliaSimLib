...
public:
    ...
    bool getFloat(const char* variableName,float& variable) const;
    bool getFloatVector3(const char* variableName,float variable[3]) const;
...
private:
    ...
    static bool _toFloatArray(const std::vector<std::string>& vals,size_t size,float* arr);
