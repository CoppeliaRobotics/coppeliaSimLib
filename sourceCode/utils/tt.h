...
class tt
{
  public:
    ...
    static int getAllKeyValuePairs(const char *txt, std::vector<std::string> &allKeys,
    ...
    static bool extractSpaceSeparatedWord2(std::string &line, std::string &word, bool recognizeQuote,
